...
<meta property="og:description" content="Deliver New Speed and Efficiency.">
	...
	<meta property="og:image" content="../../assets/www.nvidia.com/content/dam/en-zz/Solutions/industries/restaurants/nvidia-restaurant-industry.jpg">
...
<script>
    window.addEventListener("load", () => {
        NVIDIAIndustryUseCasePlugin.mount({
            ...
            mountLocale: "en-us",
            contentJSONUrl: "./assets/images.nvidia.com/aem-dam/en-zz/Solutions/industries/restaurants/use-case-component/restaurants-content-v5.json",
            layoutJSONUrl:"./assets/images.nvidia.com/aem-dam/en-zz/Solutions/industries/restaurants/use-case-component/restaurants-layout.json",
            positioningJSONUrl:"./assets/images.nvidia.com/aem-dam/en-zz/Solutions/industries/restaurants/use-case-component/restaurants-positioning-v5.json"
        });
    });
</script></div>	
...
<div class="cmp-image             
    ...
    <div class="cmp-teaser__description">
       		...
       		<p>The <a href="./assets/developer.nvidia.com/ace/tokkio-showcase" target="_blank">NVIDIA Tokkio reference workflow</a>—built with&nbsp; NVIDIA <a href="./assets/developer.nvidia.com/nvidia-omniverse-platform/ace" target="_blank">ACE</a>—leverages<a href="./assets/developer.nvidia.com/metropolis"> </a><a href="./assets/developer.nvidia.com/riva" target="_blank">Riva NIM microservices</a> for speech, Nemotron NIM microservices for intelligence, and Audio2Face NIM microservices for animation. With ACE Agent, easily connect to vision models, recommenders, and NVIDIA Omniverse™ RTX microservice to elevate the customer service experience.&nbsp;</p>
...
<div class="youtube-video-player nv-yt-embed" style="max-width:100%" data-video-id="9dyrWq1vRug" data-thumbnail="./assets/img.youtube.com/vi_webp/9dyrWq1vRug/maxresdefault.webp">

   
   <template class="nv-yt-embed__tpl">
   <div class="iframe-wrapper">
    
    <iframe width="100%" src="./assets/www.youtube.com/embed/9dyrWq1vRug?origin=%2F&amp;hl=en&amp;mute=1&amp;autoplay=0&amp;loop=0&amp;controls=1&amp;enablejsapi=1" frameborder="0" allowfullscreen=" allow=" accelerometer;="" autoplay;="" encrypted-media;="" gyroscope;="" picture-in-picture"="" loading="9dyrWq1vRug" aria-label="YouTube Video" data-modal-autoplay="false"></iframe>
    </div>
   </template>
   ...
   <div class="nv-yt-embed__consent-overlay " role="dialog" aria-label="Consent for Optional Cookies">
      <div class="nv-yt-embed__consent-overlay-content" tabindex="-1">
         ...
         <p class="nv-yt-embed__consent-alternative">Alternatively, you can <a href="./assets/www.youtube.com/watch?v=9dyrWq1vRug" target="_blank" rel="noopener noreferrer">watch this video on YouTube</a>.</p>
      </div>
   </div>
...
<div class="youtube-video-player nv-yt-embed" style="max-width:100%" data-video-id="RAzohJygdmc" data-thumbnail="./assets/img.youtube.com/vi_webp/RAzohJygdmc/maxresdefault.webp">

   
   <template class="nv-yt-embed__tpl">
   <div class="iframe-wrapper">
    
    <iframe width="100%" src="./assets/www.youtube.com/embed/RAzohJygdmc?origin=%2F&amp;hl=en&amp;mute=1&amp;autoplay=0&amp;loop=0&amp;controls=1&amp;enablejsapi=1&amp;t=120s&amp;ab_channel=NVIDIA" frameborder="0" allowfullscreen=" allow=" accelerometer;="" autoplay;="" encrypted-media;="" gyroscope;="" picture-in-picture"="" loading="RAzohJygdmc" aria-label="YouTube Video" data-modal-autoplay="false"></iframe>
    </div>
   </template>
   ...
   <div class="nv-yt-embed__consent-overlay " role="dialog" aria-label="Consent for Optional Cookies">
      <div class="nv-yt-embed__consent-overlay-content" tabindex="-1">
         ...
         <p class="nv-yt-embed__consent-alternative">Alternatively, you can <a href="./assets/www.youtube.com/watch?v=RAzohJygdmc" target="_blank" rel="noopener noreferrer">watch this video on YouTube</a>.</p>
      </div>
   </div>
