<!DOCTYPE html><html class="html-page no-js device-macintosh browser-chrome device-desktop" xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us" style="--nv-header-height: 105px; --nv-global-nav-pull-up: 45px; --vh: 720px;"><head>
    	...
    	<div class="latest-news {{modifierClass}} {{gridLayout}}">
        	<div class="latest-news__items">
				{{#items}}<div class="latest-news__item {{#enableFeatureimg}}feature-image{{/enableFeatureimg}}">						
					<div class="latest-news__item__key-visual"><a href="/industries/robotics/{{link}}/" target="_blank"><img src="/industries/robotics/{{img.url}}/" alt="{{img.alt}}" title="{{img.alt}}"/></a></div>
					<a href="/industries/robotics/{{link}}/" target="_blank"><div class="latest-news__item__body">							
						...
						<!--/* <div class="latest-news__item_readmore"><a href="/industries/robotics/{{link}}/" target="_blank">{{readMore}}<span class="fas fa-angle-right fa-fw"></span></a></div> */-->
					</div></a>
				</div>{{/items}}
        	</div>
    	</div>
...
<script type="text/javascript">
    ...
    <div class="guideContainerWrapperNode guideContainerNode container" role="main" data-path="../../assets/www.nvidia.com/content/forms/af/nvidia-forms/deep-learning-ai/robotics-contact-us/jcr:content/guideContainer" data-guide-test-data="null" data-tmproot="ee2f6e3c-f43a-4fad-80b9-709b396cd27d">
