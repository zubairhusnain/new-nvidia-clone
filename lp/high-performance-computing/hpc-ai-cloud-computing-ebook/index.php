...
<div class="button parbase section">
		...
		<div class="text-left lap-text-left tab-text-left mob-text-left p-t-15 p-b-15 lap-p-t-15 lap-p-b-15 tab-p-t-15 tab-p-b-15 mob-p-t-15 mob-p-b-15 mobile-align ">
			<div class="noicon  ">
				<a href="/" data-analytics="btn-manual:" data-title="Read More" data-href="/" rel="noopener noreferrer" target="_blank" class="  link-btn btn-manual brand-green regular-btn " onclick="NVIDIAGDC.button.click(this, $(this).data(" href"),true,="" function()="" {="" ;return="" nvidiagdc.button.callbacks(this);="" });="" return="" false;"=""><div class="btn">Read Now</div></a>
			</div>
		</div>	
