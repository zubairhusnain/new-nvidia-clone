...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--6">
    ...
    <div id="nv-text-bed2656cad" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>NVIDIA DGX delivers a high-performance AI training compute platform designed to accelerate autonomous vehicle development. AV developers can further reduce bottlenecks with <a href="/" target="_blank">Physical AI Data Factory Blueprint</a> to curate, augment, and evaluate the massive datasets necessary for performant model training. Combining NVIDIA software, infrastructure, and expertise in a unified AI development solution lets you train and scale AV systems more efficiently.</p>
                </div>
			</div>
	</div>
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-6b3490f17f" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p style="color: rgb(255,255,255);"><a href="/omniverse/">NVIDIA Omniverse libraries</a> and <a href="/ai/cosmos/">Cosmos World Foundation Models </a>make it possible&nbsp; to reconstruct and enhance interactive simulation from <a href="/" target="_modal">real-world sensor data,</a> model physics and behavior, and generate physically accurate and diverse sensor data to accelerate AV development.</p>
                </div>
			</div>
	</div>
...
<div class="nv-button-standard              button-left button-lap-left button-tab-left button-mob-left">
  ...
  <a id="nv-button-a4f1a9b53b" class="btn-content btncta    " target="_blank" data-cmp-clickable="false " rel="noopener noreferrer" href="/">
...
<div class="nv-button-standard              button-left button-lap-left button-tab-left button-mob-left">
  ...
  <a id="nv-button-02c79574de" class="btn-content btncta    " target="_modal" data-cmp-clickable="false " href="./assets/www.youtube.com/watch?v=5EEYgxoT8kc">
...
<div id="nv-teaser-9d7bf5b8fc" class="cmp-teaser     " data-title-style="dynamic">
   ...
   <div class="nv-teaser--holder">
    ...
    <a class="cmp-teaser__action-link nv-teaser-button  " target="_blank" id="teaser-9d7bf5b8fc-cta-4a22d5ba90" rel="noopener noreferrer" href="/">Start Building
