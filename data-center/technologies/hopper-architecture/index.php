...
<div class="slider-container five-items m-t-0 m-b-0 lap-m-t-0 lap-m-b-0 tab-m-t-0 tab-m-b-0  mob-m-t-0 mob-m-b-0 background-black " id="herobanner61a3e043_1537_47ef_8fcf_aadbf8e7a2e8">
	...
	<div id="top" class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-45 p-b-0  lap-p-t-45 lap-p-b-0  tab-p-t-45 tab-p-b-0  mob-p-t-60 mob-p-b-0 ">
		...
		<div class="text-left lap-text-left tab-text-left mob-text-left p-t-15 p-b-15 lap-p-t-15 lap-p-b-15 tab-p-t-15 tab-p-b-15 mob-p-t-15 mob-p-b-15 mobile-align ">
			<div class="noicon  ">
				<a href="/" data-analytics="btn-manual:" data-title="Learn More" data-href="/" rel="noopener noreferrer" target="_blank" class="link-btn btn-manual brand-green regular-btn  bannerTracking" onclick="NVIDIAGDC.button.click(this, $(this).data(&quot;href&quot;),true, function() { ;return NVIDIAGDC.button.callbacks(this); }); return false;"><div class="btn">Learn More</div></a>
			</div>
		</div>	
