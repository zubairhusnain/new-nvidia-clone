<!DOCTYPE html><html lang="en-US" class="h-100" data-color-scheme="light"><head>
	

<title>CUDA-X Data Science Libraries | NVIDIA Developer</title>
...
<script type="application/ld+json">
  {
    ...
    "url":"./assets/developer.nvidia.com/",
    "logo": "./assets/www.nvidia.com/en-us/about-nvidia/legal-info/logo-brand-usage/_jcr_content/root/responsivegrid/nv_container_392921705/nv_container_412055486/nv_image.coreimg.100.630.png/1703060329095/nvidia-logo-horz.png",
    "sameAs": [
      "/",
      "/",
      "/"
...
<script>	
  ...
  </a> <a id="user-icon--desktop" class="nv-login svelte-lpaw1y" href="./assets/developer.nvidia.com/login" aria-label="Log in">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="n24-user-circle" viewBox="0 0 24 24">
      <defs><style>.n24-user-circle-cls-1 {fill: none; stroke: #CCC; stroke-miterlimit: 10; stroke-width: 1.5px;} .n24-bounds {fill: none;}</style></defs>
      <rect id="m-n24-icon-user-circle-bounds" class="n24-bounds" width="24" height="24"></rect>
      <g id="m-n24-icon-user-circle">
  ...
  </a> </li> </ul></div></div></div></div> <div class="nav-wrapper svelte-lpaw1y"><div class="nv-container svelte-lpaw1y"><div class="nav-links svelte-lpaw1y" role="navigation"><ul class="nav-menu svelte-lpaw1y js-nav-menu" id="accessible-megamenu-1779533454910-8"><li class="nav-item svelte-lpaw1y"><a class="dropdown svelte-lpaw1y" href="javascript:void(0);" id="accessible-megamenu-1779533454910-9" role="button" aria-controls="accessible-megamenu-1779533454910-10" aria-expanded="false" tabindex="0">Topics</a> <div class="sub-nav mega" id="accessible-megamenu-1779533454910-10" role="region" aria-hidden="true" aria-labelledby="accessible-megamenu-1779533454910-9"><ul class="sub-nav-group"><li>Artificial Intelligence</li> <li><a href="./assets/developer.nvidia.com/topics/ai/">Overview</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/ai-inference/">AI Inference</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/conversational-ai/">Conversational AI</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/cybersecurity-ai/">Cybersecurity</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/data-science">Data Science</a> </li><li><a href="./assets/developer.nvidia.com/generative-ai">Generative AI</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/retrieval-augmented-generation">Retrieval-Augmented Generation</a> </li><li><a href="./assets/developer.nvidia.com/computer-vision">Vision AI</a> </li></ul><ul class="sub-nav-group"><li>Cloud and Data Center</li> <li><a href="./assets/developer.nvidia.com/cloud-native">Cloud-Native Technologies</a> </li><li><a href="./assets/developer.nvidia.com/magnum-io">IO Acceleration</a> </li><li><a href="./assets/developer.nvidia.com/networking">Networking</a> </li></ul><ul class="sub-nav-group"><li>Design and Simulation</li> <li><a href="./assets/developer.nvidia.com/topics/cae">Computer Aided Engineering</a> </li><li><a href="./assets/developer.nvidia.com/xr">Extended Reality (XR)</a> </li><li><a href="./assets/developer.nvidia.com/physx-sdk">Physics and Dynamics Simulation</a> </li><li><a href="./assets/developer.nvidia.com/isaac/sim">Robotics Simulation</a> </li><li><a href="./assets/developer.nvidia.com/drive/simulation">Self-Driving Vehicles Simulation</a> </li></ul><ul class="sub-nav-group"><li>Graphics and Rendering</li> <li><a href="./assets/developer.nvidia.com/rtx/ray-tracing">Ray Tracing</a> </li><li><a href="./assets/developer.nvidia.com/video-and-audio-solutions">Video, Broadcast, and Display</a> </li><li><a href="./assets/developer.nvidia.com/game-engines">Game Engines</a> </li><li><a href="./assets/developer.nvidia.com/image-processing">Image Processing</a> </li></ul><ul class="sub-nav-group"><li>High-Performance Computing</li> <li><a href="./assets/developer.nvidia.com/hpc">Overview</a> </li><li><a href="./assets/developer.nvidia.com/hpc-sdk">HPC Compilers and Libraries</a> </li></ul><ul class="sub-nav-group"><li>Robotics and Edge AI</li> <li><a href="./assets/developer.nvidia.com/embedded-computing">Overview</a> </li><li><a href="/blog/blog/build-robots-with-ai/">Robotics Development</a> </li><li><a href="./assets/developer.nvidia.com/metropolis">AI-Enabled Video Analytics</a> </li><li><a href="./assets/developer.nvidia.com/embedded/jetson-developer-kits">Developer Kits</a> </li><li><a href="./assets/developer.nvidia.com/embedded/jetson-modules">Production Modules</a> </li></ul><ul class="sub-nav-group"><li>Autonomous Vehicles</li> <li><a href="./assets/developer.nvidia.com/drive">Overview</a> </li><li><a href="./assets/developer.nvidia.com/drive/drive-hyperion">Development Platform</a> </li><li><a href="./assets/developer.nvidia.com/drive/driveos">Modular Software Stack</a> </li><li><a href="./assets/developer.nvidia.com/drive/drive-sim">Simulation Platform</a> </li><li><a href="./assets/developer.nvidia.com/drive/infrastructure">AV Infastructure</a> </li></ul><ul class="sub-nav-group"><li>Quantum Computing</li> <li><a href="./assets/developer.nvidia.com/cuda-q">CUDA-Q - Quantum Platform</a> </li><li><a href="./assets/developer.nvidia.com/cuda-qx">CUDA-QX - Quantum Libraries</a> </li><li><a href="./assets/developer.nvidia.com/cuquantum-sdk">cuQuantum - Quantum SDK</a> </li><li><a href="./assets/developer.nvidia.com/cupqc">cuPQC - Accelerated PQC</a> </li></ul><ul class="sub-nav-group"><li>Topics Overview</li> <li><a href="./assets/developer.nvidia.com/topics">Topics</a> </li></ul></div> </li><li class="nav-item svelte-lpaw1y"><a class="dropdown svelte-lpaw1y" href="javascript:void(0);" id="accessible-megamenu-1779533454910-11" role="button" aria-controls="accessible-megamenu-1779533454910-12" aria-expanded="false" tabindex="0">Platforms and Tools</a> <div class="sub-nav mega" id="accessible-megamenu-1779533454910-12" role="region" aria-hidden="true" aria-labelledby="accessible-megamenu-1779533454910-11"><ul class="sub-nav-group"><li>Accelerated Computing</li> <li><a href="./assets/developer.nvidia.com/cuda-toolkit">CUDA Toolkit</a> </li><li><a href="./assets/developer.nvidia.com/gpu-accelerated-libraries">CUDA-X Libraries</a> </li><li><a href="./assets/developer.nvidia.com/tools-overview">Nsight Developer Tools</a> </li></ul><ul class="sub-nav-group"><li>AI Training and Inference</li> <li><a href="./assets/developer.nvidia.com/topics/ai/ai-inference">AI Inference</a> </li><li><a href="./assets/developer.nvidia.com/topics/ai/data-science">Data Science</a> </li><li><a href="./assets/developer.nvidia.com/ai-apps-for-rtx-pcs">RTX AI Apps</a> </li></ul><ul class="sub-nav-group"><li>Cloud Development</li> <li><a href="/">API Catalog</a> </li><li><a href="./assets/developer.nvidia.com/brev">Developer Sandbox</a> </li><li><a href="./assets/developer.nvidia.com/dgx-cloud">NVIDIA DGX Cloud</a> </li><li><a href="/">NGC Catalog - GPU-Optimized Software</a> </li></ul><ul class="sub-nav-group"><li>Simulation</li> <li><a href="./assets/developer.nvidia.com/omniverse">Omniverse</a> </li><li><a href="./assets/developer.nvidia.com/cosmos">Cosmos - World Foundation Models</a> </li><li><a href="./assets/developer.nvidia.com/ace">ACE - Digital Humans</a> </li><li><a href="./assets/developer.nvidia.com/usd">Universal Scene Description (OpenUSD)</a> </li></ul><ul class="sub-nav-group"><li>See More</li> <li><a href="./assets/developer.nvidia.com/developer-tools-catalog">Developer Tools Catalog</a> </li><li><a href="./assets/developer.nvidia.com/open-source">Open Source Catalog</a> </li><li><a href="./assets/developer.nvidia.com/platforms-and-tools">Platforms and Tools Overview</a> </li></ul></div> </li><li class="nav-item svelte-lpaw1y"><a class="dropdown svelte-lpaw1y" href="javascript:void(0);" id="accessible-megamenu-1779533454911-13" role="button" aria-controls="accessible-megamenu-1779533454911-14" aria-expanded="false" tabindex="0">Industries</a> <div class="sub-nav" id="accessible-megamenu-1779533454911-14" role="region" aria-hidden="true" aria-labelledby="accessible-megamenu-1779533454911-13"><ul class="sub-nav-group"> <li><a href="./assets/developer.nvidia.com/industries/aeco">AECO</a> </li><li><a href="./assets/developer.nvidia.com/drive">Automotive</a> </li><li><a href="./assets/developer.nvidia.com/industries/consumer-internet">Consumer Internet</a> </li><li><a href="./assets/developer.nvidia.com/industries/energy">Energy</a> </li><li><a href="./assets/developer.nvidia.com/industries/financial-services">Financial Services</a> </li><li><a href="./assets/developer.nvidia.com/industries/game-development">Gaming</a> </li><li><a href="./assets/developer.nvidia.com/industries/public-sector">Global Public Sector</a> </li><li><a href="./assets/developer.nvidia.com/industries/overview">See More</a> </li></ul></div> </li><li class="nav-item svelte-lpaw1y"><a class="dropdown svelte-lpaw1y" href="javascript:void(0);" id="accessible-megamenu-1779533454911-15" role="button" aria-controls="accessible-megamenu-1779533454911-16" aria-expanded="false" tabindex="0">Resources</a> <div class="sub-nav" id="accessible-megamenu-1779533454911-16" role="region" aria-hidden="true" aria-labelledby="accessible-megamenu-1779533454911-15"><ul class="sub-nav-group"> <li><a href="./assets/developer.nvidia.com/developer-program">Developer Program</a> </li><li><a href="./assets/developer.nvidia.com/developer-community-hub">Developer Community Hub</a> </li><li><a href="/">Developer Discord</a> </li><li><a href="/startups/">For Startups</a> </li><li><a href="./assets/developer.nvidia.com/higher-education-and-research">For Higher Education</a> </li><li><a href="/gtc/">NVIDIA GTC</a> </li><li><a href="/on-demand/">NVIDIA On-Demand</a> </li></ul></div> </li></ul></div></div></div></nav></div>

    

    <div id="page-mobile-nav-container"><div class="page-mobile-navigation"><button class="page-quick-links__header">On this page</button><ul class="page-quick-links__items"><li><a class="link-cta page-quick-links__link link-level-1" href="#section-introduction">Introduction</a></li><li><a class="link-cta page-quick-links__link link-level-1" href="#section-cuda-x-libraries">CUDA-X Libraries</a></li><li><a class="link-cta page-quick-links__link link-level-1" href="#section-get-started">Get Started</a></li><li><a class="link-cta page-quick-links__link link-level-1" href="#section-install-and-deploy">Install and Deploy</a></li><li><a class="link-cta page-quick-links__link link-level-1" href="#section-ecosystem">Ecosystem</a></li><li><a class="link-cta page-quick-links__link link-level-1" href="#section-community">Community</a></li></ul></div></div>
    <div class="page">
      <div class="product-page">
<div class="container breadcrumb-container"><div class="col"><ol class="breadcrumb">
<li class="breadcrumb-item"><a href="./assets/developer.nvidia.com/topics/" id="ivemf6-2">Topics</a></li>
<div id="ixwtf2-2" class="breadcrumb-item"><a href="./assets/developer.nvidia.com/topics/ai" id="izij21-2">AI</a></div>
<li id="ib2j25-3" class="breadcrumb-item"><a href="/topics/ai/data-science/" id="i5vko4-2">Data Science</a></li>
<div id="irsh5h-2" class="breadcrumb-item active">CUDA-X Data Science Libraries</div>
</ol></div></div>
<div class="container page"><div class="row">
<div class="col-xl-2 col-lg-3 col-md-12 col-sm-12 col-sidebar"><aside class="page__sidebar with-sticky-nav"><div class="page-navigation-container"><div data-react-class="PageNavigation" data-react-props="{&quot;draggable&quot;:&quot;true&quot;,&quot;editable&quot;:&quot;true&quot;,&quot;id&quot;:&quot;i81xo&quot;}" data-react-cache-id="PageNavigation-i81xo"><div class="page-quick-links page-navigation"><p class="p--small page-quick-links__header">On this page</p><ul><li class="page-quick-links__list-item" data-idx="0" data-lvl="1" data-parent="0"><a class="page-quick-links__link link-level-1 active" data-sub-menu="false" href="#section-introduction"> Introduction</a></li><li class="page-quick-links__list-item" data-idx="1" data-lvl="1" data-parent="1"><a class="page-quick-links__link link-level-1" data-sub-menu="false" href="#section-cuda-x-libraries"> CUDA-X Libraries</a></li><li class="page-quick-links__list-item" data-idx="2" data-lvl="1" data-parent="2"><a class="page-quick-links__link link-level-1" data-sub-menu="false" href="#section-get-started"> Get Started</a></li><li class="page-quick-links__list-item" data-idx="3" data-lvl="1" data-parent="3"><a class="page-quick-links__link link-level-1" data-sub-menu="false" href="#section-install-and-deploy"> Install and Deploy</a></li><li class="page-quick-links__list-item" data-idx="4" data-lvl="1" data-parent="4"><a class="page-quick-links__link link-level-1" data-sub-menu="false" href="#section-ecosystem"> Ecosystem</a></li><li class="page-quick-links__list-item" data-idx="5" data-lvl="1" data-parent="5"><a class="page-quick-links__link link-level-1" data-sub-menu="false" href="#section-community"> Community</a></li></ul></div></div></div></aside></div>
<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-main-content"><main class="page__content"><section class="page__section page__first-section"><div id="section-introduction" class="toc-item-anchor"></div><h1 title="Introduction" class="h--large section__heading toc-item" data-anchor-id="section-introduction">CUDA-X Data Science</h1>
<p class="p--large text-color-gray mb-0">CUDA-X™ Data Science is a collection of open-source libraries that accelerate popular data science libraries and platforms. It is part of the CUDA-X collection of highly optimized, domain-specific libraries built on CUDA®.<br><br>CUDA-X Data Science includes zero code change APIs to accelerate popular PyData tools like pandas, scikit-learn, as well as distributed computing frameworks like Apache Spark. With 100+ integrations with open-source libraries and tools in the data science and data processing ecosystem, CUDA-X Data Science democratizes access to accelerated data science.<br></p>
<div class="separator separator--45"></div>
<p class="mb-0"><a href="/?_gl=1*kwbd1w*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODk0OTQkbzk1JGcwJHQxNzUyMTg5NDk0JGo2MCRsMCRoMA" target="_blank" class="btn btn-cta me-2 mt-2">Download Now</a><a href="/" target="_blank" class="btn btn-cta btn-cta--light mt-2 me-2">Documentation</a></p>
<div class="separator separator--45"></div></section><img src="../../../assets/developer.download.nvidia.com/images/cuda-x/cuda-diagram-data-science-and-ai-application-stack.png" id="iqxg7r" alt=" NVIDIA CUDA-X Data Science open-source libraries" class="img-fluid"><hr class="separator separator--md">
<section class="page__section page__second-section pb-0 pt-0"><div id="section-cuda-x-libraries" class="toc-item-anchor"></div><h2 title="CUDA-X Libraries" class="h--medium section__heading toc-item" data-anchor-id="section-cuda-x-libraries">CUDA-X Data Science Libraries </h2>
<p class="p--large text-color-gray mb-0">Accelerate data analytics, machine learning, graphs as well as data intensive applications such as vector search to get the highest performance possible on single GPUs or scale up to distributed systems using simple zero code change interfaces.</p>
<div class="separator separator--45"></div>
<div class="row cards-grid--60 cards__list">
<div id="i9k1ds-2-3-2-2" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuDF: 50x Faster pandas</h3>
<div class="separator separator--15"></div>
<p class="mb-0">cuDF is a GPU-accelerated library that optimizes fundamental DataFrame operations. It includes drop-in accelerators for popular DataFrame tools like pandas, Polars, and Apache Spark with no code changes required. <br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/cudf/" target=" id="izy1r5-2-3-2-3-2" class="link-cta text-transform-unset fw-bold">Learn More About cuDF</a></div>
<div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-6" class="link-cta text-transform-unset fw-bold">Run the Benchmark</a><div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-5" class="link-cta text-transform-unset fw-bold">View Docs</a><div class="separator separator--15"></div>
<a href="/?_gl=1*kwbd1w*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODk0OTQkbzk1JGcwJHQxNzUyMTg5NDk0JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-4" class="link-cta text-transform-unset fw-bold">Install Now</a><div class="separator separator--15"></div>
<p class="mb-0"><b>TAGS: pandas, dataframe, Python,Cc++</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-4" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuML: 50x Faster scikit-learn</h3>
<div class="separator separator--15"></div>
<p class="mb-0">cuML is a GPU-accelerated machine learning library that optimizes 
machine learning algorithms for execution on GPUs. It includes 
accelerators that run machine learning algorithms in scikit-learn, UMAP,
 and HDBSCAN with no code changes required.&nbsp;</p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/cuml/" target=" id="izy1r5-2-3-2-3-2-7" class="link-cta text-transform-unset fw-bold">Learn More About cuML</a></div>
<div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-6-4" class="link-cta text-transform-unset fw-bold">Run the Benchmark</a><div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-5-4" class="link-cta text-transform-unset fw-bold">View Docs</a><div class="separator separator--15"></div>
<a href="/?_gl=1*kwbd1w*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODk0OTQkbzk1JGcwJHQxNzUyMTg5NDk0JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-4-4" class="link-cta text-transform-unset fw-bold">Install Now</a><div class="separator separator--15"></div>
<p class="mb-0"><b id="ik9l7g">TAGS: scikit-learn, machine learning, Python, C++</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuGraph: 48x Faster NetworkX</h3>
<div class="separator separator--15"></div>
<p class="mb-0">cuGraph is a GPU-accelerated graph analytics library that optimizes graph algorithms for execution on GPUs to process millions of nodes without specialized software. It includes a zero-code-change accelerator for NetworkX.&nbsp;</p>
<div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-6-4-2" class="link-cta text-transform-unset fw-bold">Run the Benchmark</a><div class="separator separator--15"></div>
<a href="/" target="_blank" id="izy1r5-2-3-2-3-2-5-4-2" class="link-cta text-transform-unset fw-bold">View Docs</a><div class="separator separator--15"></div>
<a href="/?_gl=1*kwbd1w*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODk0OTQkbzk1JGcwJHQxNzUyMTg5NDk0JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-4-4-2" class="link-cta text-transform-unset fw-bold">Install Now</a><div class="separator separator--15"></div>
<p class="mb-0"><b id="i280i7">TAGS: NetworkX, graph, Python, C++</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">Apache Spark Accelerated with cuDF</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Learn more about our accelerator plug-in for Apache Spark workflows.</p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/deep-learning-ai/solutions/data-science/apache-spark-3/" target="_blank" id="izy1r5-2-3-2-3-2-2-2" class="link-cta text-transform-unset fw-bold">Learn More About GPU-Accelerated Spark</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="ixg8sf">TAGS: machine learning, data processing, distributed computing, Scala, Python</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-3" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">Dask-RAPIDS</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Scale out GPU-accelerated data science pipelines to multiple nodes on Dask.</p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-3" class="link-cta text-transform-unset fw-bold">Get Started on GitHub</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="irvwet">Tags: distributed computing, Python</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuxfilter</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Create interactive data visuals with multidimensional filtering of over 100-million-row tabular datasets.</p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2" class="link-cta text-transform-unset fw-bold">Get Started With cuxfilter</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="i0bxvj">Tags: dashboards, visualization, Python<br></b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2-6" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuCIM</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Mirror scikit-image for image manipulation and OpenSlide for image loading with the cuCIM API.<br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/?_gl=1*w4ryfi*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODUyMjUkbzk0JGcwJHQxNzUyMTg1MjI1JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-6" class="link-cta text-transform-unset fw-bold">Get Started With cuCIM</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="i0bxvj-6">Tags: computer vision, vision processing, Python</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2-5" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">cuVS</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Apply cuVS algorithms to accelerate vector search, including world-class performance from CAGRA.<br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/cuvs/" target=" id="izy1r5-2-3-2-3-2-2-2-2-5" class="link-cta text-transform-unset fw-bold">Get Started With cuVS</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="i0bxvj-5">TAGS: vector search, Python, C++, c, rust<br></b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2-4" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">RAFT</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Use RAFT’s CUDA-accelerated primitives to rapidly compose analytics. <br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/?_gl=1*1jr70u0*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODUyMjUkbzk0JGcwJHQxNzUyMTg1MjI1JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-4" class="link-cta text-transform-unset fw-bold">Get Started With RAFT</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="i0bxvj-4">Tags: primitives, algorithms, CUDA, Python, C++</b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2-3" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">KvikIO<br>
</h3>
<div class="separator separator--15"></div>
<p class="mb-0">Take full advantage of NVIDIA® GPUDirect® Storage (GDS) through powerful bindings to cuFile.<br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/?_gl=1*w4ryfi*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODUyMjUkbzk0JGcwJHQxNzUyMTg1MjI1JGo2MCRsMCRoMA.." target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-3" class="link-cta text-transform-unset fw-bold">Get Started With KviKIO</a></div>
<div class="separator separator--15"></div>
<p class="mb-0"><b id="i0bxvj-3">Tags: FILEIO, GPUDirectStorage, Python, C++<br></b></p>
</div></div></div></div>
<div id="i9k1ds-2-3-2-2-2-2-2-2" class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4"><div class="card-wrapper"><div class="card"><div class="card__content">
<h3 class="txt-clr--blck mb-0 h--smallest">Other CUDA-X Data Science and Processing Libraries<br>
</h3>
<div class="separator separator--15"></div>
<p class="mb-0">See a complete list of libraries and tools.<br></p>
<div class="separator separator--15"></div>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-2" class="link-cta text-transform-unset fw-bold">Check out GitHub</a></div>
</div></div></div></div>
</div></section><hr class="separator separator--md">
<div id="section-get-started" class="toc-item-anchor"></div><h2 title=" class="h--medium section__heading toc-item" data-anchor-id="section-get-started">Get Started</h2>
<div class="nv-tabs" style="--active-tab-width: 195.6875px; --active-tab-x-offset: 0px;">
<div role="tablist" class="tab-container me-auto">
<div role="tab" aria-controls="ivm0ui" id="iz8p0z" class="nav-item tab-active" aria-selected="true" data-tab-idx="0" tabindex="0"><span id="ivaro5">Hands-On Tutorials</span></div>
<div role="tab" aria-controls="i8lsth" id="ic3i47" class="nav-item" aria-selected="false" data-tab-idx="1" tabindex="-1"><span id="iarp1i">Training</span></div>
</div>
<div>
<div role="tabpanel" id="ivm0ui" class="tab-content"><div class="row">
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h3 id="i3wayl-7" class="h--smallest">Starter Kit: Accelerated Data Analytics With pandas Code<br>
</h3>
<p id="i55sd5-7">This kit demonstrates how to create responsive dashboards on large-scale data using pandas code and PyViz libraries, leveraging cuDF for accelerated exploratory data analytics with zero code changes.<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny" data-icon="play"><div><p class="mb-0">Video: <a href="./assets/www.youtube.com/watch?v=PJpCJsqcfOk" id="ir1joi" target="_blank">Accelerated Exploratory Data Analysis With pandas on NVIDIA GPUs</a> (16:06)</p></div></li>
<li id="iawbny-2" data-icon="file"><div><p class="mb-0">Notebook: <a href="/" id="ia7bwa" target="_blank">Build an Interactive Dashboard Notebook</a></p></div></li>
</ul>
</div>
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h3 id="i3wayl-7-3" class="h--smallest">Starter Kit: Accelerated Machine Learning on XGBoost<br>
</h3>
<p id="i55sd5-7-3">XGBoost is the most popular Python library for gradient boosted decision trees. It supercharges machine learning models for classification, regression and ranking workflows.<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny-3" data-icon="play"><div>
<p class="mb-0">Video:&nbsp;</p>
<h1 class="style-scope ytd-watch-metadata">
<a href="./assets/www.youtube.com/watch?v=lhraJRaDkOA" id="iuateu" target="_blank">Accelerated Machine Learning with XGBoost on NVIDIA GPUs</a> (20:10)</h1>
<p></p>
</div></li>
<li id="iawbny-2-2-2" data-icon="file"><div><p class="mb-0">Notebook: <a href="/" id="i1x1hq" target="_blank">Get Started With Accelerating XGBoost Workflows on GPUs</a></p></div></li>
</ul>
</div>
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h3 id="i3wayl-7-2" class="h--smallest">Starter kit: Accelerated Machine Learning With cuML Code</h3>
<p id="i55sd5-7-2">cuML accelerates popular machine learning algorithms, including Random Forest, UMAP, and HDBSCAN<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny-4" data-icon="play"><div><p class="mb-0">Video: <a href="./assets/www.youtube.com/watch?v=cIJsVq8CPys" id="i6t8m8" target="_blank">cuML Accelerates Machine Learning by 50x With Zero Code Change </a>(00:55)</p></div></li>
<li id="iawbny-2-3" data-icon="file"><div id="ijtg12"><p class="mb-0">Blog: <a href="./assets/developer.nvidia.com/blog/nvidia-cuml-brings-zero-code-change-acceleration-to-scikit-learn/" id="idu1e6" target="_blank">NVIDIA cuML Brings Zero-Code-Change Acceleration to scikit-learn</a></p></div></li>
<li id="iawbny-2-2-3" data-icon="file"><div><p class="mb-0">Notebook: <a href="/" id="iafojm" target="_blank">Get Started With Accelerating Popular Machine Learning Libraries</a> </p></div></li>
</ul>
</div>
<div class="separator separator--45"></div>
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h4 id="i3wayl-7-4" class="h--smallest">Starter Kit: Accelerated Data Analytics With Apache Spark</h4>
<p id="i55sd5-7-4">The NVIDIA RAPIDS™ accelerator for Apache Spark accelerates enterprise-level data workloads to drive cost savings.<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny-5" data-icon="play"><div><p class="mb-0">Video: <a href="/on-demand/session/gtc25-dlit71528/" id="i5kx0w" target="_blank">Accelerate Data Analytics on GPUa With the RAPIDS Accelerator for Apache Spark</a> (1:27:34)</p></div></li>
<li id="iawbny-2-4" data-icon="file"><div><p class="mb-0">Blog: <a href="./assets/developer.nvidia.com/blog/predicting-performance-on-apache-spark-with-gpus/" id="ixsp8y" target="_blank">Predicting Performance on Apache Spark with GPUs</a></p></div></li>
<li id="iawbny-2-2-4" data-icon="file"><div id="ivyknv"><p class="mb-0">User <a href="/" id="i6b67j" target="_blank">Guide: RAPIDS Accelerator for Apache Spark User Guide</a></p></div></li>
</ul>
</div>
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h4 id="i3wayl-7-6" class="h--smallest">Starter Kit: Accelerated Data Analytics With Polars Code<br>
</h4>
<p id="i55sd5-7-6">Polars is known for its high performance and memory optimizations. Experience even faster execution when you call the GPU engine powered by cuDF.<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny-6" data-icon="play"><div><p class="mb-0">Video: <a href="./assets/www.youtube.com/watch?v=AoKeit2Fbmw" id="iyguhx" target="_blank">Processing 100 Million Rows of Data in Under 2 Seconds With Polars</a> (00:28)</p></div></li>
<li id="iawbny-2-5" data-icon="file"><div><p class="mb-0">Blog: <a href="./assets/developer.nvidia.com/blog/polars-gpu-engine-powered-by-rapids-cudf-now-available-in-open-beta/" id="if3nwj" target="_blank">Get Started with Accelerating Polars</a></p></div></li>
<li id="iawbny-2-2-5" data-icon="file"><div><p class="mb-0">Notebook: <a href="/?utm_source=nvidia+mktg&amp;utm_medium=web&amp;utm_campaign=polars+launch" id="i1ya39" target="_blank">Accelerate Polars Data Processing Workflows Notebook</a></p></div></li>
</ul>
</div>
<div class="col-sm-12 col-lg-4 col-md-6 col-12 col-xl-4">
<h4 id="i3wayl-7-5" class="h--smallest">Starter Kit: Accelerated Graph Analytics With NetworkX Code<br>
</h4>
<p id="i55sd5-7-5">NetworkX  accelerates popular graph algorithms, including Louvain, Betweeness Centrality, and PageRank.<br></p>
<ul class="nv-list nv-list--vert-stacked">
<li id="iawbny-7" data-icon="play"><div id="id7f33"><p class="mb-0">Video: <a href="./assets/www.youtube.com/watch?v=3EsbU1gcH5c" id="ilse4r" target="_blank">Achieve up to 500x Faster NetworkX With Zero Code Changes Using NVIDIA cuGraph</a> (00:42)</p></div></li>
<li id="iawbny-2-6" data-icon="file"><div><p class="mb-0">Blog: <a href="./assets/developer.nvidia.com/blog/networkx-introduces-zero-code-change-acceleration-using-nvidia-cugraph/" id="ifd02l" target="_blank">NetworkX Introduces Zero-Code-Change Acceleration Using NVIDIA cuGraph</a></p></div></li>
<li id="iawbny-2-2-6" data-icon="file"><div><p class="mb-0">Notebook: <a href="/?ncid=so-othe-145635-vt27" id="idmcoj" target="_blank">Accelerated Graph Analytics Notebook</a></p></div></li>
</ul>
</div>
</div></div>
<div role="tabpanel" id="i8lsth" class="tab-content" hidden=""><div class="row">
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-8" class="h--smallest">Data Science Learning Path</h3>
<p id="i55sd5-8">Get an overview of everything DLI offers for upskilling in accelerated data science.</p>
<div class="card__cta"><a href="/learn/learning-path/accelerated-data-science/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2" class="link-cta text-transform-unset fw-bold">Learn More</a></div>
</div>
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-3-3" class="h--smallest">Accelerated Data Science Workflows With Zero Code Change</h3>
<p id="i55sd5-3-3">Take our free self-paced course to learn how to transform your workflow with zero-code-change acceleration.<br></p>
<div class="card__cta"><a href="/?course_id=course-v1:DLI+T-DS-03+V1" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2-2" class="link-cta text-transform-unset fw-bold">Learn More</a></div>
</div>
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-2-3" class="h--smallest">Get Certified in Accelerated Data Science</h3>
<p id="i55sd5-2-3">Gain a deeper understanding of accelerated data science in our certification course.</p>
<div class="card__cta"><a href="/learn/certification/accelerated-data-science-professional/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2-3" class="link-cta text-transform-unset fw-bold">Learn More</a></div>
</div>
</div></div>
</div>
</div> <p class="mb-0"></p>
<hr class="separator separator--md">
<section class="page__section page__second-section pb-0 pt-0"><div id="section-install-and-deploy" class="toc-item-anchor"></div><h2 title="Install and Deploy" class="h--medium section__heading toc-item" data-anchor-id="section-install-and-deploy">Install and Deploy in Your Environment</h2></section><div class="nv-tabs" style="--active-tab-width: 137.046875px; --active-tab-x-offset: 0px;">
<div role="tablist" class="tab-container me-auto">
<div role="tab" aria-controls="ifxlap" id="ig3iie" class="nav-item tab-active" aria-selected="true" data-tab-idx="0" tabindex="0"><span id="i924yb">Quick Install</span></div>
<div role="tab" aria-controls="i8ehh6" id="i6tfb7" class="nav-item" aria-selected="false" data-tab-idx="1" tabindex="-1"><span id="iefsjd">Deployment Guides</span></div>
</div>
<div>
<div role="tabpanel" id="ifxlap" class="tab-content"><div class="row cards-grid--60">
<div id="i9k1ds-2-3-2-4-2" class="col-sm-12 col-lg-6 col-md-12">
<div class="card-wrapper"></div>
<h3 id="iqatyl-2-2" class="h--smaller">Quick Install With conda</h3>
<p id="i39cqo-2-2-2">1.&nbsp;If not installed, download and run the install script. This will install the latest miniforge:</p>
<div data-react-init-class="CodeContainer" data-react-props="{&quot;pLanguage&quot;:&quot;bash&quot;,&quot;show_collapse_expand_toggle&quot;:false,&quot;expanded&quot;:false,&quot;rows&quot;:&quot;&quot;,&quot;class&quot;:&quot;nv-code-container&quot;}" data-react-cache-id="CodeContainer-isk3wf"><div class="nv-code-container"><div class="nv-code-container__header"><div class="nv-code-container__title">Bash</div><div class="nv-code-container__actions"><button><div class="nv-code-container__tooltip">Copied</div><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/copy-23a0700cd65362629d8c.svg" alt="Copy" title="Copy">Copy</button></div></div><div class="nv-code-container__content" style="--nv-code-snippet-viewport-height: NaNpx; --nv-code-snippet-viewport-height-initial: NaNpx;"><pre class="prism-code language-bash" style="background-color: rgb(250, 250, 250); color: rgb(56, 58, 66);"><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">wget "/"</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">bash Miniforge3-$(uname)-$(uname -m).sh</span></div></pre></div><div class="nv-code-container__expand-button d-none"><button><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/chevron-down-3bedf6eabfb8ef17ff14.svg" alt="Expand"></button></div></div></div>
<div class="separator separator--15"></div>
<p id="i39cqo-2-3">2. Then install with:</p>
<div data-react-init-class="CodeContainer" data-react-props="{&quot;pLanguage&quot;:&quot;bash&quot;,&quot;class&quot;:&quot;nv-code-container&quot;}" data-react-cache-id="CodeContainer-ikt7px"><div class="nv-code-container"><div class="nv-code-container__header"><div class="nv-code-container__title">Bash</div><div class="nv-code-container__actions"><button><div class="nv-code-container__tooltip">Copied</div><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/copy-23a0700cd65362629d8c.svg" alt="Copy" title="Copy">Copy</button></div></div><div class="nv-code-container__content" style="--nv-code-snippet-viewport-height: 255px; --nv-code-snippet-viewport-height-initial: 255px;"><pre class="prism-code language-bash" style="background-color: rgb(250, 250, 250); color: rgb(56, 58, 66);"><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">conda create -n rapids-26.04 -c rapidsai -c conda-forge rapids=26.04 python=3.13 'cuda-version&gt;=13.0,&lt;=13.1'</span></div></pre></div><div class="nv-code-container__expand-button d-none"><button><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/chevron-down-3bedf6eabfb8ef17ff14.svg" alt="Expand"></button></div></div></div>
<div class="separator separator--45"></div>
</div>
<div id="i9k1ds-2-3-2-3-2-2" class="col-sm-12 col-lg-6 col-md-12">
<div class="card-wrapper"></div>
<h3 id="iqatyl-3" class="h--smaller">Quick Install With pip</h3>
<div data-react-init-class="CodeContainer" data-react-props="{&quot;pLanguage&quot;:&quot;bash&quot;,&quot;class&quot;:&quot;nv-code-container&quot;}" data-react-cache-id="CodeContainer-icwdj1"><div class="nv-code-container"><div class="nv-code-container__header"><div class="nv-code-container__title">Bash</div><div class="nv-code-container__actions"><button><div class="nv-code-container__tooltip">Copied</div><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/copy-23a0700cd65362629d8c.svg" alt="Copy" title="Copy">Copy</button></div></div><div class="nv-code-container__content" style="--nv-code-snippet-viewport-height: 255px; --nv-code-snippet-viewport-height-initial: 255px;"><pre class="prism-code language-bash" style="background-color: rgb(250, 250, 250); color: rgb(56, 58, 66);"><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">Install via the NVIDIA PyPI index:</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain" style="display: inline-block;">
</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">pip install \</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">  --extra-index-url=/ \</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">  cudf-cu13==26.4.* \</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">  dask-cudf-cu13==26.4* \</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">  cuml-cu13==26.4.* \</span></div><div class="token-line" style="color: rgb(56, 58, 66);"><span class="token plain">  cugraph-cu13==26.4.*</span></div></pre></div><div class="nv-code-container__expand-button d-none"><button><img src="../../../assets/www.nvidia.com/packs/static/components/code-container/icons/chevron-down-3bedf6eabfb8ef17ff14.svg" alt="Expand"></button></div></div></div>
</div>
</div></div>
<div role="tabpanel" id="i8ehh6" class="tab-content" hidden=""><div class="row">
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-8-2" class="h--smallest">Deploy Locally</h3>
<p id="i55sd5-8-2">Use this guide to install and build with conda, pip, Docker, or WSL2 on your local machine.<br></p>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2-4" class="link-cta text-transform-unset fw-bold">Read the Local Deployment Guide</a></div>
</div>
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-3-3-2" class="h--smallest">Deploy on Platforms<br>
</h3>
<p id="i55sd5-3-3-2">Deploy CUDA-X Data Science libraries on your platform of choice, including Kubernetes, Databricks, and Google Colab.&nbsp;</p>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2-2-2" class="link-cta text-transform-unset fw-bold">Read the Platforms Guide</a></div>
</div>
<div class="col-sm-12 col-lg-4 col-md-4">
<h3 id="i3wayl-2-3-2" class="h--smallest">Deploy in the Cloud</h3>
<p id="i55sd5-2-3-2">Run CUDA-X Data Science libraries in AWS, Azure, GCP, and more. <br></p>
<div class="card__cta"><a href="/" target="_blank" id="izy1r5-2-3-2-3-2-2-2-2-5-2-3-2" class="link-cta text-transform-unset fw-bold">Read the Cloud Deployment Guide</a></div>
</div>
</div></div>
</div>
</div>
<hr class="separator separator--md">
<section class="page__section page__second-section pb-0 pt-0"><div id="section-ecosystem" class="toc-item-anchor"></div><h2 title="Ecosystem" class="h--medium section__heading toc-item text-center" data-anchor-id="section-ecosystem">The Accelerated Data Science Ecosystem</h2>
<p id="ibiuxf" class="text-center p--large">Data practitioners in open-source libraries, commercial software, and industries are driving innovation with CUDA-X Data Science. <br></p>
<p id="ihcigx-2" class="text-center"></p>
<div class="nv-tabs" style="--active-tab-width: 224.0625px; --active-tab-x-offset: 0px;">
<div role="tablist" class="tab-container">
<div role="tab" aria-controls="iy6jpi" id="iaqmi6" class="nav-item tab-active" aria-selected="true" data-tab-idx="0" tabindex="0"><span id="ijtyk7">Open-Source Libraries</span></div>
<div role="tab" aria-controls="ied625" id="iin1ri" class="nav-item" aria-selected="false" data-tab-idx="1" tabindex="-1"><span id="im0b67">Platforms</span></div>
<div role="tab" aria-controls="inu1qv" id="ieyvh8" class="nav-item" aria-selected="false" data-tab-idx="2" tabindex="-1"><span id="iipvot">Industry Adoption</span></div>
</div>
<div>
<div role="tabpanel" id="iy6jpi" class="tab-content"><div class="row">
<div id="i2peis" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/apache-arrow-logo.svg" id="iucqst" alt="Data Science Open-Source Library - Apache Arrow" class="img-fluid mx-auto"></div>
<div id="i2peis-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/apache-spark-logo.svg" id="iucqst-2-2" alt="Data Science Open-Source Library - Apache Spark" class="img-fluid mx-auto"></div>
<div id="ir4rir" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/cupy-logo.svg" id="iucqst-2" alt="Data Science Open-Source Library - CuPy" class="img-fluid mx-auto"></div>
<div id="ir4rir-12" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/dask-logo.svg" id="iucqst-2-13" alt=" Data Science Open-Source Library - Dask" class="img-fluid mx-auto"></div>
<div id="ir4rir-11" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/dmlc-xgboost-logo.svg" id="iucqst-2-12" alt="Data Science Open-Source Library - Dmlc XGBoost" class="img-fluid mx-auto"></div>
<div id="ir4rir-10" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/holoviz-logo.svg" id="iucqst-2-11" alt=" Data Science Open-Source Library - HoloViz" class="img-fluid mx-auto"></div>
<div id="ir4rir-9" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/networkx-logo.svg" id="iucqst-2-10" alt="Data Science Open-Source Library - NetworkX" class="img-fluid mx-auto"></div>
<div id="ir4rir-8" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/numba-logo.svg" id="iucqst-2-9" alt="Data Science Open-Source Library - Numba" class="img-fluid mx-auto"></div>
<div id="ir4rir-7" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/polars-logo.svg" id="iucqst-2-8" alt=" Data Science Open-Source Library - Polars" class="img-fluid mx-auto"></div>
<div id="ir4rir-6" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/pyg-logo.svg" id="iucqst-2-7" alt="Data Science Open-Source Library - PyG" class="img-fluid mx-auto"></div>
<div id="ir4rir-5" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/pytorch-logo.svg" id="iucqst-2-6" alt="Data Science Open-Source Library - PyTorch" class="img-fluid mx-auto"></div>
<div id="ir4rir-4" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/scikit-learn-logo.svg" id="iucqst-2-5" alt="Data Science Open-Source Library - Scikit Learn" class="img-fluid mx-auto"></div>
<div id="ir4rir-3" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/scverse-logo.svg" id="iucqst-2-4" alt=" Data Science Open-Source Library - scverse" class="img-fluid mx-auto"></div>
</div></div>
<div role="tabpanel" id="ied625" class="tab-content" hidden=""><div class="row">
<div id="i2peis-4" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/amazon-sagemaker-logo.svg" id="iucqst-4" alt="Data Science Platform - Amazon SageMaker" class="img-fluid mx-auto"></div>
<div id="i2peis-2-3" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/anaconda-logo.svg" id="iucqst-2-2-3" alt="Data Science Platform - Anaconda" class="img-fluid mx-auto"></div>
<div id="ir4rir-13" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/azure-machine-learning-logo.svg" id="iucqst-2-14" alt="Data Science Platform - Azure Machine Learning" class="img-fluid mx-auto"></div>
<div id="ir4rir-12-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/cloudera-logo.svg" id="iucqst-2-13-2" alt="Data Science Platform - Cloudera" class="img-fluid mx-auto"></div>
<div id="ir4rir-11-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/databricks-logo.svg" id="iucqst-2-12-2" alt="Data Science Platform - Databricks" class="img-fluid mx-auto"></div>
<div id="ir4rir-10-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/dataproc-logo.svg" id="iucqst-2-11-2" alt="Data Science Platform - Google Cloud Dataproc" class="img-fluid mx-auto"></div>
<div id="ir4rir-9-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/determined-ai-logo.svg" id="iucqst-2-10-2" alt="Data Science Platform - Determined AI" class="img-fluid mx-auto"></div>
<div id="ir4rir-8-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/domino-logo.svg" id="iucqst-2-9-2" alt="Data Science Platform - Domino" class="img-fluid mx-auto"></div>
<div id="ir4rir-7-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/google-colab-logo.svg" id="iucqst-2-8-2" alt="Data Science Platform - Google Colab" class="img-fluid mx-auto"></div>
<div id="ir4rir-6-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/iguazio-logo.svg" id="iucqst-2-7-2" alt="Data Science Platform - Iguazio" class="img-fluid mx-auto"></div>
<div id="ir4rir-5-2" class="col-6 col-sm-6 col-lg-3 col-md-4"><img src="../../../assets/developer.download.nvidia.com/images/logos/snowflake-logo.svg" id="iucqst-2-6-2" alt="Data Science Platform - Snowflake" class="img-fluid mx-auto"></div>
<div id="ir4rir-4-2" class="col-6 col-sm-6 col-lg-3 col-md-4"></div>
<div id="ir4rir-3-2" class="col-6 col-sm-6 col-lg-3 col-md-4"></div>
</div></div>
<div role="tabpanel" id="inu1qv" class="tab-content" hidden=""><div class="row cards__list">
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/att-logo.svg" id="iucqst-2-6-3-2" alt="Data Science Industry Adoption - AT&amp;T" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og">AT&amp;T applied the RAPIDS Accelerator for Apache Spark on GPU clusters in their data-to-AI pipeline.<br></p>
<a href="./assets/developer.nvidia.com/blog/scaling-data-pipelines-att-optimizes-speed-cost-and-efficiency-with-gpus/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog</a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/bunq-logo.svg" id="iucqst-2-6-3-2-9" alt=" Data Science Industry Adoption - bunq" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-9">bunq improved fraud detection accuracy by accelerating model training 100x and data processing 5x using NVIDIA CUDA-X libraries.</p>
<a href="/blog/blog/europe-financial-services-ai/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog</a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/capital-one-logo.svg" id="iucqst-2-6-3-2-8" alt=" Data Science Industry Adoption - CapitalOne" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-8">Capital One accelerated their financial and credit analysis pipelines, improving model training by 100x.<br></p>
<a href="/on-demand/session/gtcsj20-s22136/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/checkout-logo.svg" id="iucqst-2-6-3-2-7" alt="Data Science Industry Adoption - Checkout.com" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-7">Checkout.com accelerated their data analysis workflows from minutes to seconds with NVIDIA cuDF.<br></p>
<a href="/blog/blog/europe-financial-services-ai/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog</a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/cloudera-logo.svg" id="iucqst-2-6-3-2-6" alt="Data Science Industry Adoption - Cloudera" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-6">The IRS team uncovered fraud with the RAPIDS Accelerator for Apache Spark on the Cloudera Data Platform. <br></p>
<a href="/blog/blog/2021/09/07/cloudera-spark-irs-gpus/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog</a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/linkedin-logo.svg" id="iucqst-2-6-3-2-5" alt="Data Science Industry Adoption - Linkedin" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-5">LinkedIn developed DARWIN to enable faster data analysis on NVIDIA cuDF.<br></p>
<a href="/on-demand/session/gtcspring23-s51399/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/nasa-logo.svg" id="iucqst-2-6-3-2-4" alt="Data Science Industry Adoption - NASA" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-4">NASA used CUDA-X Data Science to detect and quantify air pollution anomalies and build a bias-correction model. <br></p>
<a href="./assets/developer.nvidia.com/blog/nasa-and-nvidia-collaborate-to-accelerate-scientific-data-science-use-cases-part-1/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog: Part 1</a><a href="./assets/developer.nvidia.com/blog/nasa-and-nvidia-collaborate-to-accelerate-scientific-data-science-use-cases-part-2/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Blog: Part 2</a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/paypal-logo.svg" id="iucqst-2-6-3-2-3" alt="Data Science Industry Adoption - PayPal" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-3">PayPal reduced cloud costs by up to 70% with the RAPIDS Accelerator for Apache Spark. <br></p>
<a href="/on-demand/session/gtc24-s62506/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/taboola-logo.svg" id="iucqst-2-6-3-2-3-5" alt=" Data Science Industry Adoption - Taboola" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-3-5">Taboola, an advertising platform, processes terabytes of hourly data with the RAPIDS Accelerator for Apache Spark.</p>
<a href="/on-demand/session/gtc24-s62130/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/tgen-logo.svg" id="iucqst-2-6-3-2-3-4" alt="Data Science Industry Adoption - Tgen" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-3-4">TGen cut analysis time on 4 million-cell datasets from 10 hours to three minutes with RAPIDS-singlecell, built on CUDA-X Data Science.<br></p>
<a href="/customer-stories/reduce-single-cell-spatial-analysis-from-hours-to-minutes/" target="_blank" class="link-cta text-transform-unset fw-bold">Read Customer Story<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/tcs-logo.svg" id="iucqst-2-6-3-2-3-3" alt="Data Science Industry Adoption - TCS" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-3-3">TCS Optumera accelerated their demand forecasting pipeline with the RAPIDS Accelerator for Apache Spark. <br></p>
<a href="/on-demand/session/gtcspring22-s42508/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/uber-logo.svg" id="iucqst-2-6-3-2-3-2" alt="Data Science Industry Adoption - Uber" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-3-2">Uber developed Horovod with support for Spark 3.x with GPU scheduling. </p>
<a href="/on-demand/session/gtcsj20-s21300/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
<div class="col-lg-3 col-sm-12 col-md-6"><div class="card-wrapper"><div class="card">
<img src="../../../assets/developer.download.nvidia.com/images/logos/walmart-logo.svg" id="iucqst-2-6-3-2-2" alt="Data Science Industry Adoption - Walmart" class="img-fluid mx-auto"><div class="card__content">
<p id="i257og-2">Walmart solved scalability issues with their product-substitution algorithm.<br></p>
<a href="/on-demand/session/gtcspring22-s42259/" target="_blank" class="link-cta text-transform-unset fw-bold">Watch On-Demand Session<i class="chevron-right"></i></a>
</div>
</div></div></div>
</div></div>
</div>
</div></section><hr class="separator separator--md">
<section class="page__section page__last-section pb-0 pt-0"><div id="section-community" class="toc-item-anchor"></div><h2 title="Community" class="h--medium section__heading tablet-45 toc-item" data-anchor-id="section-community">Join the Community</h2>
<div id="iedinv-2-2-3"><div class="row cards__list">
<div id="ir7h78-2-2-4-2" class="col-sm-12 col-12 col-md-6 col-lg-6 col-xl-6"><div class="card-wrapper"><div class="card extra-resource">
<img src="../../../assets/developer.download.nvidia.com/icons/m48-people-group.svg" id="i9pjs2-2-2-4-2" alt=" class="img-fluid mw-6-rem mx-auto"><h3 id="izp2a2" class="txt-clr--blck mb-0 text-center h--smallest">Join the Accelerated Data Science Community on Slack</h3>
<a href="/" target="_blank" id="i16c9u-2-2-4-2"></a>
</div></div></div>
<div id="ir7h78-2-2-3-3" class="col-sm-12 col-12 col-md-6 col-lg-6 col-xl-6"><div class="card-wrapper"><div class="card extra-resource">
<img src="../../../assets/developer.download.nvidia.com/icons/m48-email-settings.svg" id="i9pjs2-2-2-3-3" alt=" class="img-fluid mw-6-rem mx-auto"><h3 id="ict3zp" class="txt-clr--blck mb-0 text-center h--smallest">Sign Up for the Data Science Newsletter</h3>
<a href="/email-signup/" target=" id="i16c9u-2-2-3-3"></a>
</div></div></div>
</div></div></section><hr class="separator separator--md">
<section class="page__section page__last-section pb-0 pt-0"><h2 class="h--medium section__heading tablet-45">Ethical AI </h2>
<div id="iedinv-2-2-3-3"></div></section><p id="i4kuz5">NVIDIA believes Trustworthy AI is a shared responsibility and we have established policies and practices to enable development for a wide array of AI applications. When downloaded or used in accordance with our terms of service, developers should work with their supporting team to ensure their application meets requirements for the relevant industry and use case and addresses unforeseen product misuse. <br><br>Please report security vulnerabilities or NVIDIA AI Concerns <a href="/support/submit-security-vulnerability/" id="if56yl" target="_blank">here</a>.</p>
<div class="separator separator--60"></div>
<section class="page__section page__section--light-gray page__last-section page__cta-section"><h3 class="section__heading text-center h--small">Download CUDA-X Data Science libraries today.<br>
</h3>
<p class="text-center mb-0"><a href="/?_gl=1*kwbd1w*_ga*MTE4NDAwMTQ1NS4xNzA5NzcwODcw*_ga_RKXFW6CM42*czE3NTIxODk0OTQkbzk1JGcwJHQxNzUyMTg5NDk0JGo2MCRsMCRoMA" target="_blank" class="btn btn-cta">Download</a></p></section></main></div>
<div class="col-xl-1 col-separator"></div>
</div></div>
  ...
  <script defer="">
    setTimeout(() => {
      LIBRARIAN.Home.mount({
        ...
        searchPage: false,
        placeholder: '',
        site: './assets/developer.nvidia.com/',
        retainFilters: true,
        overlay: true,
        pillsOpen: true,
        suggestedSearchPills: []
...
<script>
  ...
  fetch(`/menu/${menuLocale}/footer.json`)
    .then(response => response.json())
    .then(data => {
      mountFooter(data);
    })
