...
<meta name="keywords" content="Ada Lovelace Architecture, NVIDIA, professional visualization, RTX, PCI Express Gen 4.0, CUDA cores, Tensor Cores">
<meta name="description" content="The NVIDIA Ada Lovelace architecture builds on the power of RTX to enhance the performance of rendering, graphics, AI, and compute workloads.">
<meta name="nv-pub-date" content="2023-08-11T07:01:34.000Z">
<meta name="nv-cre-date" content="2023-03-21T17:09:21.000Z">
<meta name="nv-update-date" content="2023-08-11T07:01:34.000Z">
<meta name="nv-id" content="L2NvbnRlbnQvbnZpZGlhR0RDL3VzL2VuX1VTL3RlY2hub2xvZ2llcy9hZGEtYXJjaGl0ZWN0dXJl">
...
<link rel="canonical" href="/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-gr" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="pt-br" href="/pt-br/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-pt" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="es-mx" href="/es-la/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-lt" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-hu" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-lv" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="es-ar" href="/es-la/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-ee" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="ko-kr" href="/ko-kr/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-us" href="/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-in" href="/en-in/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-il" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-au" href="/en-au/technologies/ada-architecture/">

	<link rel="alternate" hreflang="ja-jp" href="/ja-jp/technologies/ada-architecture/">

	<link rel="alternate" hreflang="zh-tw" href="/zh-tw/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-rs" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="es-co" href="/es-la/technologies/ada-architecture/">

	<link rel="alternate" hreflang="es-cl" href="/es-la/technologies/ada-architecture/">

	<link rel="alternate" hreflang="es-pe" href="/es-la/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-sg" href="/en-sg/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-sk" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-si" href="/en-eu/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-gb" href="/en-gb/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en-ca" href="/technologies/ada-architecture/">

	<link rel="alternate" hreflang="en" href="/technologies/ada-architecture/">

	<link rel="alternate" hreflang="x-default" href="/technologies/ada-architecture/">

<link rel="alternate" type="text/markdown" title="NVIDIA Ada Lovelace for Professional Visualization" href="/technologies/ada-architecture.md/">
...
<title>Ada Lovelace Architecture | NVIDIA</title>
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
		...
		<div id="container-dac29f9970" class="p-t-0 p-b-0  lap-p-t-0 
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 aem-Grid--phone--12 ">
    ...
    <div class="nv-title text h--large aem-GridColumn--default--none aem-GridColumn--phone--none aem-GridColumn--phone--12 aem-GridColumn aem-GridColumn--default--7 aem-GridColumn--offset--phone--0 aem-GridColumn--offset--default--0">
      ...
      <div id="nv-title-930beb0355" class="general-container-text            ">
...
<div class="nv-text text aem-GridColumn--default--none aem-GridColumn aem-GridColumn--default--5 aem-GridColumn--offset--default--0">
...
<div class="nv-text text nv-no-top-padding nv-no-bottom-padding aem-GridColumn--default--none aem-GridColumn aem-GridColumn--default--7 aem-GridColumn--offset--default--0">
 
 	
    <div id="nv-text-27f0731ef8" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p><span style="color: rgb(255,255,255);"><span class="p--large">Performance and energy efficiency for endless possibilities.</span></span></p>
                </div>
			</div>
	</div>
...
<div class="nv-button-standard              button-left button-lap-left button-tab-left button-mob-left">
  ...
  <a id="nv-button-4190454ef4" class="btn-content btncta    " data-title="Stay Informed" target="_self" data-cmp-clickable="false " href="/preferences/email-signup/">
...
<div class="aem-Grid aem-Grid--12 aem-Grid--tablet--12 aem-Grid--default--12 aem-Grid--phone--12 ">
    ...
    <div id="container-e961b3f3c6" class="p-t-0 p-b-0  lap-p-t-0 
         lap-p-b-0  tab-p-t-0 tab-p-b-0 
          mob-p-t-0 mob-p-b-0  
      ...
      <div id="nv-title-5729fdca07" class="general-container-text            ">
...
<div class="nv-text text">
    ...
    <div id="nv-text-bf4e3b15a6" class="general-container-text            ">
			<div class="text-center lap-text-center tab-text-center mob-text-center">
				<div class="description ">
                	<p><span class="p--large">The NVIDIA Ada Lovelace architecture has been designed to power incredible performance for professional graphics, video, AI, and compute. Defining a dramatically higher baseline of GPU performance, it marks the tipping point for AI, ray tracing, and neural graphics. </span></p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
		...
		<div id="container-e62d4b2b2c" class="p-t-75 p-b-60  lap-p-t-75 
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
		...
		<div id="container-302d784813" class="p-t-0 p-b-15  lap-p-t-0 
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--medium nv-no-top-padding aem-GridColumn aem-GridColumn--default--12">
  
    
      <div id="nv-title-29e6eb45eb" class="general-container-text            ">
        <div class="text-center lap-text-center tab-text-center mob-text-center">
          <h2 class="title " style="color: #000000;">
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-a22ac27c5c" class="p-t-0 p-b-8  lap-p-t-0 
         lap-p-b-8  tab-p-t-0 tab-p-b-0 
          mob-p-t-0 mob-p-b-0  
...
<div id="nv-teaser-d6a2b30afe" class="cmp-teaser     " data-title-style="dynamic">
   ...
   <div class="nv-teaser--holder">
    ...
    <div class="cmp-teaser__description">
       		...
       		<p>The architecture’s <a href="/data-center/l4/">NVIDIA L4 Tensor Core GPU </a>and <a href="/data-center/l40/">NVIDIA L40 GPU</a> accelerate performance for data center workloads.&nbsp;</p> 
<p>L4 is optimized for video streaming and inference at scale for a broad range of AI applications, including recommenders, AI assistants, visual search, and contact center automation.&nbsp;</p> 
<p>L40 is the most powerful NVIDIA RTX™-enabled GPU for the data center, delivering unprecedented performance for visualization, rendering, virtualization, simulation, and AI.</p>
...
<div id="nv-teaser-7f46f0e309" class="cmp-teaser     " data-title-style="dynamic">
   ...
   <div class="nv-teaser--holder">
    ...
    <div class="cmp-teaser__description">
       		...
       		<p>The <a href="/design-visualization/rtx-6000/">NVIDIA RTX 6000 Ada Generation GPU</a> is the ultimate workstation GPU, delivering unprecedented rendering, AI, graphics, data science, and compute performance for professional visualization workloads.&nbsp;</p> 
<p>The NVIDIA Ada Lovelace architecture powers a variety of <a href="/design-visualization/desktop-graphics/">desktops</a> and <a href="/design-visualization/rtx-professional-laptops/">laptops</a> to maximize productivity and creativity.</p>
    ...
    <a class="cmp-teaser__action-link nv-teaser-text-link  " target="_self" id="teaser-7f46f0e309-cta-4450524f54" href="/design-visualization/rtx/">Learn More About NVIDIA RTX
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--medium aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-2a6a5d8188" class="general-container-text            ">
        <div class="text-center lap-text-center tab-text-center mob-text-center">
          <h2 class="title ">
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-97251bd0a6" class="p-t-30 p-b-0  lap-p-t-30 
    	...
    	<div class="general-container nv-flexbox d-col-2 l-col-2 t-col-2 p-col-1 d-justify-left l-justify-left t-justify-left p-justify-left flex-align-stretch p-column-reverse ">
	        
	        <div class="nv-container container responsivegrid">

    
	
		<div id="container-5b08491d58" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-7a3178fb41" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-b715eef39b" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>Third-generation RT Cores deliver up to 2X the ray-tracing performance over the previous generation, delivering groundbreaking performance for photorealistic rendering. Enhanced RT Cores combined with Shader Execution Reordering (SER) technology dynamically reorder inefficient workloads, dramatically improving shader performance to accelerate end-to-end ray-traced image rendering performance.</p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-7452804fd6" class="p-t-30 p-b-30  lap-p-t-30 
...
<div class="nv-container container responsivegrid">
		...
		<div id="container-ab32cebb17" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-7c9cfcb7d6" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-9a5992f153" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>The Ada Lovelace architecture’s Tensor Cores are designed to accelerate transformative AI technologies like intelligent chatbots, generative AI, <a href="/training/instructor-led-workshops/natural-language-processing/">natural language processing</a> (NLP), computer vision, and<a href="/geforce/technologies/dlss/"> NVIDIA Deep Learning Super Sampling 3.0</a> (DLSS 3). Ada Lovelace Tensor Cores unleash structured sparsity and 8-bit floating point (FP8) precision for up to 4X higher inference performance over the previous generation. FP8 reduces memory pressure when compared to larger precisions and dramatically accelerates AI throughput.</p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-a790b3abd8" class="p-t-0 p-b-0  lap-p-t-0 
         lap-p-b-0  tab-p-t-0 tab-p-b-0 
          mob-p-t-0 mob-p-b-0  
		...
		<div id="container-3c93e95b6e" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-c85186e3df" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-a40e1612f2" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>The Ada-based CUDA® cores bring double-speed processing for single-precision floating point (FP32) operations over the previous-generation GPUs. This provides significant performance gains for graphics workflows like 3D model development and compute workflows like desktop simulation for computer-aided engineering (CAE).</p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-ed9c95891b" class="p-t-30 p-b-30  lap-p-t-30 
         lap-p-b-30  tab-p-t-15 tab-p-b-15 
          mob-p-t-15 mob-p-b-15  
...
<div class="nv-container container responsivegrid">
		...
		<div id="container-b2cf905d70" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-4c75b6b9f3" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-c03ffe2a13" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>NVIDIA Ada Lovelace GPUs take video and vision AI acceleration to the next level and bring our optimized AV1 stack, creating a broad array of new possibilities for use cases like video transcoding, streaming, video conferencing, augmented reality (AR), virtual reality (VR), and vision AI. With up to 2X as many decoders and encoders, combined with the AV1 video format, Ada Lovelace GPUs can host up to 3X more video streams concurrently than the previous generation. On top of this, additional JPEG decoders further speed up applications that need computer vision horsepower. </p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-86163c0550" class="p-t-0 p-b-0  lap-p-t-0 
         lap-p-b-0  tab-p-t-0 tab-p-b-0 
          mob-p-t-0 mob-p-b-0  
		...
		<div id="container-9d26feade0" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-c300ec7b5b" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-6d84fd7bda" class="p-t-30 p-b-30  lap-p-t-30 
         lap-p-b-30  tab-p-t-15 tab-p-b-15 
          mob-p-t-15 mob-p-b-15  
...
<div class="nv-container container responsivegrid">
		...
		<div id="container-cb1dff951c" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-88682ffafe" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-128b399f67" class="p-t-0 p-b-30  lap-p-t-0 
		...
		<div id="container-c6be92b2d3" class="    
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div class="nv-title text h--small aem-GridColumn aem-GridColumn--default--12">
      ...
      <div id="nv-title-bd65080efb" class="general-container-text            ">
        <div class="text-left lap-text-left tab-text-left mob-text-left">
          <h2 class="title ">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="nv-text-c31009ed58" class="general-container-text            ">
			<div class="text-left lap-text-left tab-text-left mob-text-left">
				<div class="description ">
                	<p>The NVIDIA Ada Lovelace L4 and L40 GPUs are optimized for 24/7 enterprise data center operations and designed, built, extensively tested, and supported by NVIDIA and partners for maximum performance, durability, and security. Both the NVIDIA L40 and L4 GPUs feature secure boot with root-of-trust technology, providing an additional layer of security for data centers.</p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-0a2256f922" class="p-t-0 p-b-60  lap-p-t-0 
         ...
         d-content-align-top l-content-align-top t-content-align-top m-content-align-top 
         " data-cmp-is="nv-container" style="background-color:#EEE;">
		...
		<div id="container-ceb564fc0c" class="p-t-75 p-b-15  lap-p-t-75 
         lap-p-b-15  tab-p-t-60 tab-p-b-0
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 aem-Grid--phone--12 aem-Grid--laptop--12 ">
    ...
    <div class="nv-title text h--smaller aem-GridColumn--laptop--none aem-GridColumn aem-GridColumn--default--12 aem-GridColumn--laptop--12 aem-GridColumn--offset--laptop--0">
  
    
      <div id="nv-title-6790a6e230" class="general-container-text            ">
        <div class="text-center lap-text-center tab-text-center mob-text-center">
          <h3 class="title ">
...
<div id="nv-image-4627f5edb4" class="cmp-image             
     d-align-center l-align-center t-align-center m-align-center" itemscope="" itemtype="http://schema.org/ImageObject" data-cmp-lazy="" data-cmp-lazythreshold="300" data-cmp-src="../../assets/www.nvidia.com/content/dam/en-zz/Solutions/design-visualization/technologies/turing-architecture/m48-document-120x120.svg" data-asset="../../assets/www.nvidia.com/content/dam/en-zz/Solutions/design-visualization/technologies/turing-architecture/m48-document-120x120.svg" data-title="NVIDIA Ada Lovelace Architecture White Paper" data-cmp-type="renditionUpload">
     	<a class="cmp-image__link" href="./assets/images.nvidia.com/aem-dam/en-zz/Solutions/technologies/NVIDIA-ADA-GPU-PROVIZ-Architecture-Whitepaper_1.1.pdf" target="_blank" data-cmp-hook-image="link" rel="noopener noreferrer">
    ...
    <img class="cmp-image__image" itemprop="contentUrl" style="max-width:96px" alt="NVIDIA Ada Lovelace Architecture White Paper" title="NVIDIA Ada Lovelace Architecture White Paper" data-analytics="nv-image-4627f5edb4" data-cmp-img-custom-width="96px" data-cmp-hook-image="image" src="../../assets/www.nvidia.com/content/dam/en-zz/Solutions/design-visualization/technologies/turing-architecture/m48-document-120x120.svg">
	    ...
	    <meta itemprop="caption" content="NVIDIA Ada Lovelace Architecture White Paper">
  </div>
...
<div class="nv-button-standard              button-center button-lap-center button-tab-center button-mob-center">
  ...
  <a id="nv-button-71b1c684d9" class="btn-content btncta    " target="_blank" data-cmp-clickable="false " rel="noopener noreferrer" href="./assets/images.nvidia.com/aem-dam/en-zz/Solutions/technologies/NVIDIA-ADA-GPU-PROVIZ-Architecture-Whitepaper_1.1.pdf">
    
    

    <span class="btn-text"><span class="far fa-file-pdf fa-fw"></span>NVIDIA Ada Lovelace Architecture White Paper</span>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
		...
		<div id="container-f44fa01ca5" class="p-t-60 p-b-60  lap-p-t-60 
...
<div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
    ...
    <div id="nv-text-cb5655f22d" class="general-container-text            ">
			<div class="text-center lap-text-center tab-text-center mob-text-center">
				<div class="description ">
                	<p><span style="color: rgb(0,0,0);"><span style="color: rgb(255,255,255);"><span class="p--large">Learn more about NVIDIA RTX-powered workstations and NVIDIA-Certified Systems™ for enterprises.</span></span></span></p>
                </div>
			</div>
	</div>
...
<div class="nv-container container responsivegrid aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="container-57b9e36ed7" class="p-t-0 p-b-0  lap-p-t-0 
         lap-p-b-0  tab-p-t-0 tab-p-b-0 
          mob-p-t-0 mob-p-b-0  
...
<div class="nv-button-standard              button-right button-lap-right button-tab-right button-mob-center">
  ...
  <a id="nv-button-98f5494660" class="btn-content btncta    " target="_self" data-cmp-clickable="false " href="/design-visualization/workstations/">
    
    

    <span class="btn-text">Explore RTX-Powered Workstations</span>
...
<div class="nv-button-standard              button-left button-lap-left button-tab-left button-mob-center">
  ...
  <a id="nv-button-f5ef69626c" class="btn-content btncta    " target="_self" data-cmp-clickable="false " href="/data-center/products/certified-systems/">
    
    

    <span class="btn-text">Explore NVIDIA-Certified Systems</span>
