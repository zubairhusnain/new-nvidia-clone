...
<link rel="canonical" href="/technologies/cuda-x/">
	...
	<link rel="alternate" hreflang="zh-cn" href="https://www.nvidia.cn/technologies/cuda-x/">
...
<div class="youtube-video-player nv-yt-embed" style="max-width:850px" data-video-id="CyP0SutKhzw" data-thumbnail="../../assets/www.nvidia.com/content/dam/en-zz/Solutions/technologies/cuda-x/nvidia-cuda-x-libraries.jpg" data-thumbnail-alt="A series of images showing the top workloads CUDA-X libraries are applied to, including bioscience, physics, LLM diagrams, and more.">
   ...
   <div class="nv-yt-embed__consent-overlay " role="dialog" aria-label="Consent for Optional Cookies">
      <div class="nv-yt-embed__consent-overlay-content" tabindex="-1">
         ...
         <p class="nv-yt-embed__consent-alternative">Alternatively, you can <a href="https://www.youtube.com/watch?v=CyP0SutKhzw" target="_blank" rel="noopener noreferrer">watch this video on YouTube</a>.</p>
      </div>
   </div>
...
<div class="nv-button-standard              button-center button-lap-center button-tab-center button-mob-center">
  ...
  <a id="nv-button-59be11731f" class="btn-content btncta    " data-title="Learn More" target="_blank" data-cmp-clickable="false " rel="noopener noreferrer" href="https://developer.nvidia.com/gpu-accelerated-libraries">
...
<div class="nv-text text aem-GridColumn aem-GridColumn--default--12">
    ...
    <div id="text-cta-row" class="general-container-text            ">
			<div class="text-center lap-text-center tab-text-center mob-text-center">
				<div class="description ">
                	<p><span style="color: rgb(255,255,255);"><a href="https://developer.nvidia.com/deep-learning" target="_blank">DL Training</a> <span class="pipe">|</span> <a href="https://developer.nvidia.com/machine-learning" target="_blank">Machine Learning</a> <span class="pipe">|</span> <a href="https://developer.nvidia.com/computeworks" target="_blank">HPC </a><span class="pipe">|</span> <a href="https://developer.nvidia.com/tensorrt" target="_blank">DL Inference</a></span></p>
                </div>
			</div>
	</div>
