...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="nvidia-container">
			<article id="post-92454" class="post-with-sidebar grid grid-cols-1 laptop:grid-cols-4 desktop:grid-cols-4 w-full gap-[30px] post-92454 post type-post status-publish format-standard has-post-thumbnail hentry category-enterprise category-cloud-2 tag-agentic-ai tag-artificial-intelligence tag-cloud-services tag-cosmos tag-inception tag-isaac tag-nemotron tag-nvidia-blackwell tag-nvidia-nemo tag-nvidia-rubin tag-nvlink tag-omniverse tag-open-source tag-physical-ai" data-url="https://blogs.nvidia.com/blog/google-cloud-agentic-physical-ai-factories/" data-identifier="92454 https://blogs.nvidia.com/?p=92454" data-title="NVIDIA and Google Cloud Collaborate to Advance Agentic and Physical AI">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=NVIDIA and Google Cloud Collaborate to Advance Agentic and Physical AI https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fgoogle-cloud-agentic-physical-ai-factories%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fgoogle-cloud-agentic-physical-ai-factories%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
<p><span style="font-weight: 400;">Global enterprises, AI labs and high‑growth startups are using NVIDIA and Google Cloud’s co-engineered platform to move from prototyping to production faster, including </span><span style="font-weight: 400;">Snap</span><span style="font-weight: 400;">, </span><span style="font-weight: 400;">Schrödinger</span><span style="font-weight: 400;"> and </span><span style="font-weight: 400;">Salesforce</span><span style="font-weight: 400;">. </span><a href="/blog/blog/snap-accelerated-data-processing/"><span style="font-weight: 400;">Snap</span></a><span style="font-weight: 400;"> is cutting the cost of large‑scale A/B testing by shifting data pipelines to GPU‑accelerated Spark on Google Cloud. </span><a target="_blank" href="https://www.youtube.com/watch?v=607ZZ0Zp5jo"><span style="font-weight: 400;">Schrödinger</span></a><span style="font-weight: 400;"> is shrinking weekslong drug discovery simulations into just hours with NVIDIA accelerated computing on Google Cloud.</span></p>
...
<p><span style="font-weight: 400;">As part of a </span><a target="_blank" href="https://cloud.google.com/blog/topics/startups/startups-are-building-the-agentic-future-with-google-cloud"><span style="font-weight: 400;">broader ecosystem</span></a><span style="font-weight: 400;"> highlighted through </span><a target="_blank" href="/startups/"><span style="font-weight: 400;">NVIDIA Inception</span></a><span style="font-weight: 400;"> and Google for Startups, </span><a target="_blank" href="https://www.coderabbit.ai/blog/faster-code-reviews-with-nemotron-3-super"><span style="font-weight: 400;">CodeRabbit</span></a><span style="font-weight: 400;"> and </span><a target="_blank" href="https://factory.ai/"><span style="font-weight: 400;">Factory</span></a> <span style="font-weight: 400;">are using NVIDIA Nemotron‑based models on Google Cloud to power code review and autonomous software development agents, while </span><span style="font-weight: 400;">Aible</span><span style="font-weight: 400;">, </span><span style="font-weight: 400;">Mantis AI</span><span style="font-weight: 400;">,</span> <a target="_blank" href="https://www.photoroom.com/inside-photoroom"><span style="font-weight: 400;">Photoroom</span></a><span style="font-weight: 400;"> and </span><span style="font-weight: 400;">Baseten</span><span style="font-weight: 400;"> are building enterprise data, video intelligence, generative imagery and managed inference solutions on the full‑stack NVIDIA platform on Google Cloud.</span></p>
...
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/google-cloud-agentic-physical-ai-factories/" data-title="NVIDIA and Google Cloud Collaborate to Advance Agentic and Physical AI" data-hashtags=" data-post-id="92454"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/google-cloud-agentic-physical-ai-factories/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
