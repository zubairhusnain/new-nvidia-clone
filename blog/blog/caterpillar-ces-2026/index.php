...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
	...
	<meta name="author" content="Madison Huang">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:creator" content="@NVIDIA">
	<meta name="twitter:site" content="@NVIDIA">
	<meta name="twitter:label1" content="Written by">
	<meta name="twitter:data1" content="Madison Huang">
...
<body class="wp-singular post-template post-template-full-width-layout-template post-template-full-width-layout-template-php single single-post postid-88923 single-format-standard wp-embed-responsive wp-theme-nvidia-blog-v6 site-lang-en group-blog has-body">
...
<div class="full-width-layout__hero light overlay-text-dark" style="--overlay-rgb: 255, 255, 255; --overlay-opacity: 0.6;">
	<div class="full-width-layout__hero-content light overlay-text-dark">
		<div class="full-width-layout__hero-content__inner nvidia-container-full-width-bleed light overlay-text-dark">
			<h1 class="full-width-layout__hero-title nvidia-heading-xl">Steel, Sensors and Silicon: How Caterpillar Is Bringing Edge AI to the Jobsite</h1>

							<div class="full-width-layout__hero-subtitle-desktop nvidia-text-xl">
					 At CES, Caterpillar reveals how it’s integrating NVIDIA technologies, from NVIDIA Jetson Thor to speech models, to transform the world’s heavy industries. 				</div>
			
			<div class="full-width-layout__hero-post-meta nvidia-text-regular">
				January 7, 2026 by <a href="/blog/blog/author/madisonh/" title="Posts by Madison Huang" class="author url fn author-url" rel="author">Madison Huang</a>			</div>
		</div>
	</div>

	<div class="full-width-layout__hero-media">
		<video class="full-width-layout__hero-video js-responsive-video" autoplay=" muted=" loop=" playsinline=" data-sources="{&quot;mobile&quot;:[{&quot;src&quot;:&quot;../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/Caterpillar_Phone_768-x-432_13MB.mp4&quot;,&quot;type&quot;:&quot;video/mp4&quot;}],&quot;desktop&quot;:[{&quot;src&quot;:&quot;../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/Caterpillar_Desktop_2560-x-1440_14MB.mp4&quot;,&quot;type&quot;:&quot;video/mp4&quot;}]}">
	...
	<p class="leading-[2]"> X </p>
			...
			</a><a href="#ea-share-count-email" class="ea-share-count-button style- ea-share-no-count email" data-postid="88923" data-nonce="b6d4d9a651" "=""><span class="ea-share-count-icon-label"><i class="ea-share-count-icon easc-envelope"></i><span class="ea-share-count-label">Email</span></span><span class="ea-share-count">0</span></a>		</div>
...
<p>“Hey Cat, how do I get started?”</p>
<p>A voice answered, generated by an AI system running directly on the machine. It interpreted the request, accessed information and responded in a natural voice. On screen, the arm lifted. The crowd leaned forward. For a moment, the future wasn’t a slide or a spec sheet. It was right there, in steel and silicon.</p>
<p>Caterpillar, as CEO Joe Creed put it, “builds and powers the invisible layer of the world’s modern tech stack.” Every device in the room, and every data center behind today’s AI boom, depends on minerals extracted from the earth and infrastructure that never sleeps.</p>
<p>“That’s the work Caterpillar does, at scale, all around the world,” Creed said.</p>
<p>At CES, that invisible layer streamed onto stage, paired with AI designed to help operators work more safely, efficiently and intuitively.</p>
<p>Caterpillar’s machines are built for versatility across climates, terrains and job demands. And the Cat 306 CR Mini Excavator, already recognized for precision and operator‑assist features, can be found at jobsites large and small across the world.</p>
</div></div>

<div class="full-width-layout__full-width-image-section">
			<div class="aspect-[16/9]"><img width="1449" height="768" src="../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/cat-306.png" class="full-width-layout__image" alt="" loading="lazy" decoding="async" srcset="../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/cat-306.png 1449w, ../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/cat-306-960x509.png 960w, ../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/cat-306-1280x678.png 1280w, ../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/cat-306-630x334.png 630w" sizes="auto, (max-width: 1449px) 100vw, 1449px"></div>	
	
<div class="full-width-layout__inner">
			<span class="full-width-layout__media-caption-callout">
			The Cat 306 CR Mini Excavator, recognized for precision and operator‑assist features, can be found at jobsites large and small across the world.		</span>
...
<div class="full-width-layout__article-copy-section light">
	<div class="full-width-layout__copy"><p>In the demo, the Cat AI Assistant ran on <a href="/autonomous-machines/embedded-systems/jetson-thor/">NVIDIA Jetson Thor</a>, an edge AI platform built for real‑time inference in industrial and robotic systems.</p>
<p><a href="/ai-data-science/products/riva/">NVIDIA Riva</a> handles speech, using <a href="/ai-data-science/foundation-models/nemotron/">NVIDIA Nemotron</a> speech models for fast and accurate natural voice interactions.</p>
<p>Qwen3 4B, served locally via vLLM, interprets requests and generates responses with low latency, no cloud link required.</p>
<p>Caterpillar’s Helios data platform supplies trusted machine context.</p>
<p>Here’s how the technology came together at CES:</p>
<p><strong>Safety and Boundaries (E‑Ceiling):</strong> Operators demonstrated using assistance features to support machine positioning, including limiting range of motion to avoid hazards overhead or underground. Voice interaction accelerates this setup — for example, adjusting floor boundaries above known utilities.</p>
<p><strong>Intuitive Control:</strong> In tight spaces, the Cat 306’s control options matter. AI acts as an assistant, helping operators locate features, understand machine behavior and troubleshoot through natural dialog.</p>
<p><strong>In‑Cab AI Assistance:</strong> Caterpillar previewed the Cat AI Assistant’s potential to offer personalized tips, safety‑oriented alerts, and access to documentation and resources.</p>
<p>Together, Caterpillar and NVIDIA are exploring how these building blocks could extend across fleets and jobsites, using <a href="/edge-computing/">edge AI</a> to turn growing volumes of machine data into timely, actionable insight.</p>
<p>The story doesn’t end in the field.</p>
</div></div>

<div class="full-width-layout__full-width-video-section">
					<video class="full-width-layout__video" controls=" playsinline=" width="1920" height="1080">
							<source src="../../../assets/blogs.nvidia.com/wp-content/uploads/3026/01/11752-01-nVidia-Omniverse-Future-Of-Manufacturing-2_25MB.mp4" type="video/mp4">
...
<div class="full-width-layout__article-copy-section light">
	<div class="full-width-layout__copy"><p>Caterpillar is piloting <a href="/use-cases/industrial-facility-digital-twins/">factory digital twins</a>, built on <a href="/omniverse/">NVIDIA Omniverse</a> libraries and <a href="/glossary/openusd/">OpenUSD</a>, of multiple U.S. sites, manufacturing building and construction products as well as large mining machines.</p>
<p>Teams are using these digital twins to simulate line changes, test scheduling scenarios and optimize material flow before any physical retooling.<br>
AI’s rise is also driving new demand for physical infrastructure: roads, ports, power systems and the equipment required to build and sustain them.</p>
<p>That’s why Caterpillar is pledging $100 million over five years for workforce training and education, including a $25 million Global Workforce Innovation challenge to identify and scale solutions that prepare workers for the next generation of AI-enabled industrial systems.</p>
<p>As the Cat 306 mini excavator’s yellow paint gleamed on screen, Creed left the audience with a reminder:</p>
<p>“If you remember one thing today, I hope it’s this … Caterpillar is still the company that builds and powers the physical world you rely on every day — and now we’re making the invisible layer of the modern tech stack more intelligent.”</p>
<p>That world is getting smarter, with edge AI designed to help operators, technicians and fleet managers work with machines that can listen, explain and assist. And the rumble from these machines is the sound of the future beginning to break ground.</p>
</div></div>

<div class="full-width-layout__article-copy-section light">
	<h2 class="full-width-layout__heading nvidia-heading-medium">Technical Highlights</h2><div class="full-width-layout__copy"><p><strong>NVIDIA Jetson Thor:</strong> Edge AI platform for real-time inference on industrial and robotics systems</p>
<p><strong>NVIDIA Riva:</strong> Speech AI framework using Parakeet ASR and Magpie TTS<br>
<strong><br>
Qwen3 4B LLM:</strong> Compact large language model for intent parsing and response generation<br>
<strong><br>
vLLM:</strong> Runtime for serving LLM inference efficiently at the edge<br>
<strong><br>
Caterpillar Helios:</strong> Unified data platform providing trusted machine context<br>
<strong><br>
NVIDIA Omniverse:</strong> Digital twin and simulation libraries and frameworks for industrial workflows</p>
</div></div>
			...
			<a href="/blog/blog/category/auto/" class="nvidia-badge">Driving</a><div aria-hidden="true" class="full-width-layout__terms-separator">&nbsp;</div><a href="/blog/blog/category/robotics/" class="nvidia-badge">Robotics</a>		</div>
		</div>
...
<article class="full-width-layout__news-post-tile  post-88706 post type-post status-publish format-standard has-post-thumbnail hentry category-corporate category-deep-learning category-auto category-hardware category-supercomputing tag-ces-2026" id="related-news-post-88706" role="article" aria-labelledby="related-news-post-title-88706" aria-describedby="related-news-post-desc-88706">
	<a href="/blog/blog/2026-ces-special-presentation/" aria-hidden="true" tabindex="-1">
		<div class="aspect-[16/9]"><img width="300" height="169" src="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/ces26-nvidialive-JL3_1386-3-1280x680-1-300x169.jpg" class="w-full h-full object-cover" alt="NVIDIA Rubin Platform, Open Models, Autonomous Driving: NVIDIA Presents Blueprint for the Future at CES" sizes="(max-width: 640px) 630px, (min-width: 640px) 300px, 100vw" decoding="async" fetchpriority="high" srcset="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/ces26-nvidialive-JL3_1386-3-1280x680-1-300x169.jpg 300w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/ces26-nvidialive-JL3_1386-3-1280x680-1-960x540.jpg 960w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/ces26-nvidialive-JL3_1386-3-1280x680-1-630x355.jpg 630w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/ces26-nvidialive-JL3_1386-3-1280x680-1-400x225.jpg 400w"></div>	</a>
	...
	<div id="related-news-post-desc-88706" class="full-width-layout__news-post-excerpt	light">
...
<article class="full-width-layout__news-post-tile  post-88680 post type-post status-publish format-standard has-post-thumbnail hentry category-enterprise tag-ces-2026 tag-nvidia-bluefield tag-nvidia-dgx tag-nvidia-rubin" id="related-news-post-88680" role="article" aria-labelledby="related-news-post-title-88680" aria-describedby="related-news-post-desc-88680">
	<a href="/blog/blog/dgx-superpod-rubin/" aria-hidden="true" tabindex="-1">
		<div class="aspect-[16/9]"><img width="300" height="169" src="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/scale-ai-infrastructure-dgx-vera-rubin-nvl72-promo-pack-plan-a-1280x680-1-300x169.png" class="w-full h-full object-cover" alt="NVIDIA DGX SuperPOD Sets the Stage for Rubin-Based Systems" sizes="(max-width: 640px) 630px, (min-width: 640px) 300px, 100vw" decoding="async" srcset="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/scale-ai-infrastructure-dgx-vera-rubin-nvl72-promo-pack-plan-a-1280x680-1-300x169.png 300w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/scale-ai-infrastructure-dgx-vera-rubin-nvl72-promo-pack-plan-a-1280x680-1-960x540.png 960w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/scale-ai-infrastructure-dgx-vera-rubin-nvl72-promo-pack-plan-a-1280x680-1-630x355.png 630w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/scale-ai-infrastructure-dgx-vera-rubin-nvl72-promo-pack-plan-a-1280x680-1-400x225.png 400w"></div>	</a>

	<a id="related-news-post-title-88680" class="full-width-layout__news-post-title" href="/blog/blog/dgx-superpod-rubin/">
		NVIDIA DGX SuperPOD Sets the Stage for Rubin-Based Systems	</a>

	<div id="related-news-post-desc-88680" class="full-width-layout__news-post-excerpt	light">
		NVIDIA DGX SuperPOD is paving the way for large-scale system deployments built on the NVIDIA Rubin platform — the next leap forward in AI computing. At the CES trade show...	</div>
</article>

<article class="full-width-layout__news-post-tile  post-88652 post type-post status-publish format-standard has-post-thumbnail hentry category-generative-ai category-auto category-robotics tag-agentic-ai tag-ai-training tag-ces-2026 tag-cosmos tag-healthcare-life-sciences tag-nemotron tag-nvidia-clara tag-nvidia-nim tag-open-source tag-physical-ai tag-trustworthy-ai" id="related-news-post-88652" role="article" aria-labelledby="related-news-post-title-88652" aria-describedby="related-news-post-desc-88652">
	<a href="/blog/blog/open-models-data-tools-accelerate-ai/" aria-hidden="true" tabindex="-1">
		<div class="aspect-[16/9]"><img width="300" height="169" src="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/open-model-ces-2026-300x169.jpg" class="w-full h-full object-cover" alt="NVIDIA Unveils New Open Models, Data and Tools to Advance AI Across Every Industry" sizes="(max-width: 640px) 630px, (min-width: 640px) 300px, 100vw" decoding="async" srcset="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/open-model-ces-2026-300x169.jpg 300w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/open-model-ces-2026-960x540.jpg 960w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/open-model-ces-2026-630x355.jpg 630w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/open-model-ces-2026-400x225.jpg 400w"></div>	</a>

	<a id="related-news-post-title-88652" class="full-width-layout__news-post-title" href="/blog/blog/open-models-data-tools-accelerate-ai/">
		NVIDIA Unveils New Open Models, Data and Tools to Advance AI Across Every Industry	</a>

	<div id="related-news-post-desc-88652" class="full-width-layout__news-post-excerpt	light">
		Expanding the open model universe, NVIDIA today released new open models, data and tools to advance AI across every industry. These models — spanning the NVIDIA Nemotron family for agentic...	</div>
</article>
		</div>
	</div>
			</div>
