...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="nvidia-container">
			<article id="post-90166" class="post-with-sidebar grid grid-cols-1 laptop:grid-cols-4 desktop:grid-cols-4 w-full gap-[30px] post-90166 post type-post status-publish format-standard has-post-thumbnail hentry category-robotics tag-cosmos tag-isaac tag-jetson tag-nemotron tag-open-source tag-physical-ai tag-robotics hashtags-embedded-ai hashtags-generative-ai hashtags-gtc-2026 hashtags-nvidia-cosmos hashtags-nvidia-isaac-gr00t hashtags-nvidia-jetson hashtags-nvidia-nemotron hashtags-robotics" data-url="https://blogs.nvidia.com/blog/jetson-generative-ai-edge-oss/" data-identifier="90166 https://blogs.nvidia.com/?p=90166" data-title="As Open Models Spark AI Boom, NVIDIA Jetson Brings It to Life at the Edge">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=As Open Models Spark AI Boom, NVIDIA Jetson Brings It to Life at the Edge https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fjetson-generative-ai-edge-oss%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fjetson-generative-ai-edge-oss%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
</span><span style="font-weight: 400;">In the demo, the Cat AI Assistant ran on </span><a target="_blank" href="/autonomous-machines/embedded-systems/jetson-thor/"><span style="font-weight: 400;">NVIDIA Jetson Thor</span></a><span style="font-weight: 400;">, an edge AI platform built for real‑time inference in industrial and robotic systems, </span><a target="_blank" href="https://developer.nvidia.com/nemotron"><span style="font-weight: 400;">NVIDIA Nemotron</span></a><span style="font-weight: 400;"> speech models are used for fast and accurate natural voice interactions. Qwen3 4B, served locally via vLLM, interprets requests and generates responses with low latency, no cloud link required.</span></p>
...
<p><iframe title="YouTube video player" src="https://www.youtube.com/embed/ncKvzReJZyM?si=WWxO-PnJAOX6JIPj&amp;enablejsapi=1&amp;rel=0" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen" id="player1"></iframe></p>
...
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/jetson-generative-ai-edge-oss/" data-title="As Open Models Spark AI Boom, NVIDIA Jetson Brings It to Life at the Edge" data-hashtags="EmbeddedAI,GenerativeAI,GTC2026,NVIDIACosmos,NVIDIAIsaacGR00T,NVIDIAJetson,NVIDIANemotron,Robotics" data-post-id="90166"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/jetson-generative-ai-edge-oss/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
