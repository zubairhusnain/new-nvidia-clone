...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="nvidia-container">
			<article id="post-92302" class="post-with-sidebar grid grid-cols-1 laptop:grid-cols-4 desktop:grid-cols-4 w-full gap-[30px] post-92302 post type-post status-publish format-standard has-post-thumbnail hentry category-pro-graphics tag-art tag-artificial-intelligence tag-geforce tag-generative-ai tag-nvidia-rtx tag-nvidia-studio tag-rtx-ai-garage" data-url="https://blogs.nvidia.com/blog/rtx-ai-garage-nab-adobe-premiere-color-mode/" data-identifier="92302 https://blogs.nvidia.com/?p=92302" data-title="New Adobe Premiere Color Grading Mode Accelerated on NVIDIA GPUs">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=New Adobe Premiere Color Grading Mode Accelerated on NVIDIA GPUs https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Frtx-ai-garage-nab-adobe-premiere-color-mode%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	<p class="leading-[2]"> X </p>
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Frtx-ai-garage-nab-adobe-premiere-color-mode%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
			...
			</a></li><li class="mb-[30px]"><a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Frtx-ai-garage-nab-adobe-premiere-color-mode%2F&amp;title=Adobe+Premiere+Color+Mode+Accelerated+on+RTX+%7C+NVIDIA+Blog" class="nvb6-social-share-link flex gap-[15px] for-linkedin" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-linkedin">
...
<p><span style="font-weight: 400;"><img draggable="false" role="img" class="emoji" alt="📽️" src="/assets/s.w.org/images/core/emoji/17.0.2/svg/1f4fd.svg"> Check out this </span><a target="_blank" href="https://www.youtube.com/watch?v=RPGaakGQ6bg"><span style="font-weight: 400;">NVIDIA GTC session</span></a><span style="font-weight: 400;"> on how developers can build, run and optimize AI agents locally on NVIDIA GPUs, covering everything from quantization to backends like Ollama and applications like OpenClaw and ComfyUI.</span></p>
...
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/rtx-ai-garage-nab-adobe-premiere-color-mode/" data-title="New Adobe Premiere Color Grading Mode Accelerated on NVIDIA GPUs" data-hashtags=" data-post-id="92302"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/rtx-ai-garage-nab-adobe-premiere-color-mode/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
