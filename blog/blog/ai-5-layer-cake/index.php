...
<div class="full-width-layout__hero dark overlay-text-dark no-headline" style="--overlay-rgb: 255, 255, 255; --overlay-opacity: 0.6;">
	...
	<div class="nvidia-container-2 social-container">
		<div class="full-width-layout__social">
			...
			<a href="/?text=AI%20Is%20a%205-Layer%20Cake%20%2Fblog%2Fblog%2Fai-5-layer-cake%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	<p class="leading-[2]"> X </p>
	</a><a href="/?u=%2Fblog%2Fblog%2Fai-5-layer-cake%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
			...
			</a><a href="/?mini=true&amp;url=%2Fblog%2Fblog%2Fai-5-layer-cake%2F&amp;title=AI+Is+a+5-Layer+Cake+%7C+NVIDIA+Blog" class="nvb6-social-share-link flex gap-[15px] for-linkedin" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-linkedin">
