...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="nvidia-container">
			<article id="post-92424" class="post-with-sidebar grid grid-cols-1 laptop:grid-cols-4 desktop:grid-cols-4 w-full gap-[30px] post-92424 post type-post status-publish format-standard has-post-thumbnail hentry category-generative-ai category-pro-graphics tag-agentic-ai tag-artificial-intelligence tag-media-and-entertainment tag-nemotron tag-omniverse" data-url="https://blogs.nvidia.com/blog/adobe-ai-agents-nvidia-wpp/" data-identifier="92424 https://blogs.nvidia.com/?p=92424" data-title="Autonomous AI at Scale: Adobe Agents Unlock Breakthrough Creative Intelligence With NVIDIA and WPP">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=Autonomous AI at Scale: Adobe Agents Unlock Breakthrough Creative Intelligence With NVIDIA and WPP https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fadobe-ai-agents-nvidia-wpp%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fadobe-ai-agents-nvidia-wpp%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
<p><span style="font-weight: 400;">The expanded collaborations bring together three complementary strengths: Adobe’s creative and customer experience platforms and the new Adobe CX Enterprise Coworker, WPP’s global media and marketing expertise, and NVIDIA’s accelerated computing and software stack, including </span><a target="_blank" href="/ai-data-science/foundation-models/nemotron/"><span style="font-weight: 400;">NVIDIA Nemotron</span></a><span style="font-weight: 400;"> open models, </span><a target="_blank" href="https://developer.nvidia.com/nemo-agent-toolkit"><span style="font-weight: 400;">NVIDIA Agent Toolkit</span></a><span style="font-weight: 400;"> and the </span><a target="_blank" href="https://build.nvidia.com/openshell"><span style="font-weight: 400;">NVIDIA OpenShell</span></a><span style="font-weight: 400;"> secure runtime for building and running secure agentic AI systems.</span></p>
...
<p>&nbsp;</p>
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/adobe-ai-agents-nvidia-wpp/" data-title="Autonomous AI at Scale: Adobe Agents Unlock Breakthrough Creative Intelligence With NVIDIA and WPP" data-hashtags=" data-post-id="92424"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/adobe-ai-agents-nvidia-wpp/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
