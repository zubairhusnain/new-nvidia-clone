...
<div id="primary" class="content-area">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="/?text=NVIDIA%20Spectrum-X%20%E2%80%94%20the%20Open,%20AI-Native%20Ethernet%20Fabric%20%E2%80%94%20Sets%20the%20Standard%20for%20Gigascale%20AI,%20Now%20With%20MRC%20%2Fblog%2Fblog%2Fspectrum-x-ethernet-mrc%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="/?u=%2Fblog%2Fblog%2Fspectrum-x-ethernet-mrc%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
<p><span style="font-weight: 400;">Companies including NVIDIA, <a target="_blank" href="/">Microsoft</a> and </span><a target="_blank" href="/"><span style="font-weight: 400;">OpenAI</span></a><span style="font-weight: 400;"> have </span><a target="_blank" href="/"><span style="font-weight: 400;">demonstrated</span></a><span style="font-weight: 400;"> industry leadership by introducing Multipath Reliable Connection (MRC), an RDMA transport protocol. MRC enables a single RDMA connection to distribute traffic across multiple network paths, improving throughput, load balancing and availability for large-scale AI training fabrics.&nbsp;</span></p>
...
<p><span style="font-weight: 400;">In addition, Microsoft and NVIDIA have a longstanding collaboration focused on advancing the infrastructure required for the next generation of AI. </span><a target="_blank" href="/"><span style="font-weight: 400;">Microsoft’s Fairwater</span></a> <span style="font-weight: 400;">an</span><span style="font-weight: 400;">d <a target="_blank" href="/">Oracle Cloud Infrastructure (OCI’s) Abilene</a> data center, two of the largest AI factories purpose-</span><span style="font-weight: 400;">built for training and deploying leading-edge frontier LLMs, rely on MRC to deliver on performance, scale and efficiency requirements. NVIDIA Spectrum-X Ethernet is suited for this environment, helping provide the network foundation needed to run large-scale AI models and applications with confidence.</span></p>
<p><span style="font-weight: 400;">Proven first in production with performance optimized on NVIDIA Spectrum-X Ethernet hardware and now </span><a target="_blank" href="/"><span style="font-weight: 400;">released</span></a><span style="font-weight: 400;"> as an open specification through the Open Compute Project, MRC demonstrates the power of the Spectrum-X Ethernet platform: purpose-built hardware, deep telemetry and intelligent fabric control working together to take a new protocol — a set of rules that controls how data moves between two systems across a network — from concept to gigascale AI production.</span></p>
...
<p><i><span style="font-weight: 400;">Learn more about NVIDIA Spectrum-X Ethernet on the </span></i><a target="_blank" href="/networking/spectrumx/"><i><span style="font-weight: 400;">webpage</span></i></a><i><span style="font-weight: 400;">, </span></i><a target="_blank" href="/"><i><span style="font-weight: 400;">datasheet</span></i></a><i><span style="font-weight: 400;"> and </span></i><a target="_blank" href="/"><i><span style="font-weight: 400;">technical whitepaper</span></i></a><i><span style="font-weight: 400;">.&nbsp;</span></i></p>
...
<div class="has-social-placeholder has-content-area" data-url="/blog/blog/spectrum-x-ethernet-mrc/" data-title="NVIDIA Spectrum-X — the Open, AI-Native Ethernet Fabric — Sets the Standard for Gigascale AI, Now With MRC" data-hashtags=" data-post-id="92837"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"/blog/blog/wp-admin/admin-ajax.php","disqus_url":"/blog/blog/spectrum-x-ethernet-mrc/","language":"ICL_LANGUAGE_CODE","site_url":"/blog/blog/"};
