...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
	...
	<meta name="author" content="Ali Kani">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:creator" content="@NVIDIA">
	<meta name="twitter:site" content="@NVIDIA">
	<meta name="twitter:label1" content="Written by">
	<meta name="twitter:data1" content="Ali Kani">
...
<body class="wp-singular post-template-default single single-post postid-89389 single-format-standard wp-embed-responsive wp-theme-nvidia-blog-v6 site-lang-en group-blog has-body">
...
<div id="primary" class="content-area">
	...
	<header class="entry-header laptop:col-span-4 desktop:col-span-4">
		<div class="inner3">
			<!-- TITLE -->
			<h1 class="nvidia-heading-large mb-[15px]">NVIDIA DRIVE AV Raises the Bar for Vehicle Safety as Mercedes-Benz CLA Earns Top Euro NCAP Award</h1>
					<div class="nvb6-subtitle">
			<div class="nvb6-subtitle-inner">
				The ​​NVIDIA DRIVE AV software platform and NVIDIA Halos architecture contributed to the CLA’s top safety rating.			</div>
		</div>
				<div class="author_meta text-xs text-nvidia-text-tertiary mb-[15px]">
				<span class="entry-date">January 22, 2026</span> <span class="meta-sep">by</span> <span class="author vcard"><a href="/blog/blog/author/alikani/" title="Posts by Ali Kani" class="author url fn author-url" rel="author">Ali Kani</a></span>			</div>
		</div><!-- /inner3 -->
		<!-- META -->
		...
		<span class="bsf-rt-display-postfix" postfix="mins"></span></span>			</div>
			<div class="nvidia-meta-comments flex items-center gap-[10px]">
				...
				<div class="nvidia-comment-count">
					<a href="/blog/blog/drive-av-mercedes-benz-cla-euro-ncap-safety-award/">0</a>
				</div>
			</div>
	...
	<p class="leading-[2]"> X </p>
		...
		<!-- FEATURED IMG/VIDEO -->
				...
				<div class="tile-image-wrapper">
					<img width="1200" height="638" src="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/mb-cla-euro-ncap-2.jpg" class="attachment-medium_large size-medium_large" alt="" decoding="async" fetchpriority="high" srcset="../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/mb-cla-euro-ncap-2.jpg 1280w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/mb-cla-euro-ncap-2-960x510.jpg 960w, ../../../assets/blogs.nvidia.com/wp-content/uploads/2026/01/mb-cla-euro-ncap-2-630x335.jpg 630w" sizes="(max-width: 1200px) 100vw, 1200px">				</div>
			</div>
			</header>
...
<p>The CLA is also built on the NVIDIA DRIVE Hyperion architecture, which incorporates sensor diversity and hardware redundancy into the vehicle’s overall design.</p>
<p>At the heart of this approach is <a target="_blank" href="/ai-trust-center/halos/autonomous-vehicles/">NVIDIA Halos</a> — a comprehensive safety system spanning hardware, software, tools, development processes and certification support. Halos delivers a structured safety foundation for developing automated driving and other AI capabilities while staying anchored to robust guardrails, redundancy and fault tolerance.</p>
<p>Third-party certification and assessments are also important to build trust:</p>
<ul>
<li>TÜV SÜD granted the ISO 21434 Cybersecurity Process certification to NVIDIA for its automotive system-on-a-chip, platform and software engineering processes. Additionally, NVIDIA DriveOS 6.0 conforms to ISO 26262 Automotive Safety Integrity Level (ASIL) D standards.</li>
<li>TÜV Rheinland performed an independent United Nations Economic Commission for Europe (UNECE) safety assessment of NVIDIA DRIVE AV related to safety requirements for complex electronic systems, which NVIDIA successfully completed.</li>
</ul>
