...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="nvidia-container">
			<article id="post-92414" class="post-with-sidebar grid grid-cols-1 laptop:grid-cols-4 desktop:grid-cols-4 w-full gap-[30px] post-92414 post type-post status-publish format-standard has-post-thumbnail hentry category-robotics tag-cosmos tag-digital-twins tag-industrial-manufacturing tag-metropolis tag-nvidia-in-europe tag-omniverse tag-robotics tag-sovereign-ai" data-url="https://blogs.nvidia.com/blog/ai-manufacturing-hannover-messe/" data-identifier="92414 https://blogs.nvidia.com/?p=92414" data-title="NVIDIA and Partners Showcase the Future of AI-Driven Manufacturing at Hannover Messe 2026">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=NVIDIA and Partners Showcase the Future of AI-Driven Manufacturing at Hannover Messe 2026 https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fai-manufacturing-hannover-messe%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fai-manufacturing-hannover-messe%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
<p><span style="font-weight: 400">At a </span><a target="_blank" href="https://sie.ag/4LyPvV"><span style="font-weight: 400">Siemens</span></a><span style="font-weight: 400"> blueprint autonomous electronics factory in Erlangen, Germany, </span><a target="_blank" href="https://thehumanoid.ai/siemens-and-humanoid-bring-physical-ai-to-the-factory-floor-deploying-humanoids-in-industrial-operations-with-nvidia/"><span style="font-weight: 400">Humanoid’s HMND 01</span></a><span style="font-weight: 400"> wheeled humanoid — running the </span><a target="_blank" href="/autonomous-machines/embedded-systems/jetson-thor/"><span style="font-weight: 400">NVIDIA Jetson Thor</span></a><span style="font-weight: 400"> edge AI module for on-robot compute and developed using </span><a target="_blank" href="https://developer.nvidia.com/isaac/sim"><span style="font-weight: 400">Isaac Sim</span></a><span style="font-weight: 400"> and </span><a target="_blank" href="https://developer.nvidia.com/isaac/lab"><span style="font-weight: 400">Isaac Lab</span></a><span style="font-weight: 400"> open frameworks for simulation and reinforcement learning — has completed autonomous logistics operations in a first proof of concept within the production environment. </span><span style="font-weight: 400">Humanoid’s</span><span style="font-weight: 400"> simulation-first development compressed what typically takes up to two years of hardware development down to just seven months.</span></p>
...
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/ai-manufacturing-hannover-messe/" data-title="NVIDIA and Partners Showcase the Future of AI-Driven Manufacturing at Hannover Messe 2026" data-hashtags=" data-post-id="92414"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/ai-manufacturing-hannover-messe/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
