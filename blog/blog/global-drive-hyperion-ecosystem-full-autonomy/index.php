...
<div id="primary" class="content-area">
			...
			<div class="nvidia-meta-share flex items-center gap-[10px] relative">
				...
				<div class="nvidia-share opacity-0 translate-y-2 pointer-events-none transition-all duration-200 ease-out hidden shadow-nvidia-share absolute top-[25px] right-0 md:left-0 bg-white p-[25px] shadow-lg min-w-[216px] z-[99]" id="nvidia-share-dropdown">
					...
					<ul class="entry-meta-social-links-list">
						<li class="mb-[30px]"><a href="https://twitter.com/intent/tweet?text=NVIDIA Expands Global DRIVE Hyperion Ecosystem to Accelerate the Road to Full Autonomy https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fglobal-drive-hyperion-ecosystem-full-autonomy%2F" class="nvb6-social-share-link flex gap-[15px] for-x" target="_blank">	<span class="share-icon rounded-[5px] p-px bg-black icon-for-twitter">
	...
	</a></li><li class="mb-[30px]"><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblogs.nvidia.com%2Fblog%2Fglobal-drive-hyperion-ecosystem-full-autonomy%2F" class="nvb6-social-share-link flex gap-[15px] for-facebook" target="_blank">			<span class="share-icon rounded-[5px] p-px bg-black icon-facebook">
...
<div class="has-social-placeholder has-content-area" data-url="https://blogs.nvidia.com/blog/global-drive-hyperion-ecosystem-full-autonomy/" data-title="NVIDIA Expands Global DRIVE Hyperion Ecosystem to Accelerate the Road to Full Autonomy" data-hashtags=" data-post-id="88670"></div>		</div>
	</div>
...
var nvbThemeVars = {"ajaxUrl":"https://blogs.nvidia.com/wp-admin/admin-ajax.php","disqus_url":"https://blogs.nvidia.com/blog/global-drive-hyperion-ecosystem-full-autonomy/","language":"ICL_LANGUAGE_CODE","site_url":"https://blogs.nvidia.com"};
