...
<meta name="keywords" content="nvidia location country regional selector">
<meta name="description" content="Experience the NVIDIA website in your language, in your location.">
<meta name="nv-pub-date" content="2025-04-03T18:12:27.000Z">
<meta name="nv-cre-date" content="2026-05-21T19:01:20.000Z">
<meta name="nv-id" content="L2NvbnRlbnQvbnZpZGlhR0RDL3VzL2VuX1VTL2xvY2F0aW9uLXNlbGVjdG9y">
...
<link rel="canonical" href="/location-selector/">
 

	<link rel="alternate" hreflang="en-us" href="/location-selector/">

	<link rel="alternate" hreflang="en-ca" href="/location-selector/">

	<link rel="alternate" hreflang="en" href="/location-selector/">

	<link rel="alternate" hreflang="x-default" href="/location-selector/">
...
<title>Location and Regional Selector | NVIDIA</title>
...
<body class="body-page theme-en-us theme-deeplearning nv-megamenu v4_design base_v4" data-edit-mode=" style="">
...
<section class="background-white p-t-30 p-b-0 tab-p-t-15 tab-p-b-0 mob-p-t-15 mob-p-b-15  ">
	<div id="sectionwrapperd44f4b88_3cc5_453d_8ced_bccd88c8dc37" class="general-container ">
    ...
    <div id="textcomponentenhance4bdc17cf_f756_4c29_a264_166f397fa8f3">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-0 p-b-0  lap-p-t-0 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-left lap-text-left tab-text-left mob-text-left">
	            ...
	            <h1 class="title color-black   h2 uppercase"><strong>Select Your Location</strong></h1>
...
<style>
section li.country a {
    color: #000000;
    font-size: 18px;
}

section li.country a:hover {
    color: #76b900;
}

.geo-modal h3.gf-sub-title {
    color: #000000;
    font-weight: 600;
    margin-bottom: 30px;
}
...
window.onload = function() {       
    setTimeout(function(){
    $("#nv-cs-item a span").text("US")
    $("#nv-cs-item-mob a span").text("US")
    },500); 
}
</script>
...
<section class="background- p-t-0 p-b-0 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0  ">
	<div id="sectionwrapper_1152016250f6000f7c_47e6_48bb_9229_62c01cdd8c02" class="general-container ">
	...
	<div class="container">
		<div class="page-section-par parsys"><div class="countrylistSelector parbase section">
        
        <div id="0.9588785607147035">
            <div class="countrylistselector       ">
                <div class="countrylistsection">
                    <div class="full-width  p-t-0 p-b-0 lap-p-t-0 lap-p-b-0 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0">
                        <div class="text-left lap-text-left tab-text-left mob-text-left">
                            <h2 class="title color-brand-green">
                                <strong></strong>
                            </h2>
                        </div>
                    </div>
                ...
                <div class="countrylistsection">
                    <div class="full-width p-l-0 lap-p-l-0  tab-p-l-0 mob-p-l-0 p-t-0 p-b-0 lap-p-t-0 lap-p-b-0 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0">
                        <div class="">
                            <div class="body-text description color-ui-elements">
                                <div class="countrieswrapper">
                                    <div>
                                        <div>
                                            <div class="countrylistsection">
                                            	<div class="text-left lap-text-left tab-text-left mob-text-left p-t-30 p-b-15 lap-p-t-30 lap-p-b-15 tab-p-t-15 tab-p-b-15 mob-p-t-0 mob-p-b-15">
                                                	<h3 class="regiontitle">The Americas</h3>
                                                </div>
                                                <div>
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Argentina" data-clocale="es-la" href="/es-la/">Argentina</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Brasil (Brazil)" data-clocale="pt-br" href="/pt-br/">Brasil (Brazil)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Canada" data-clocale="en-us" href="/">Canada</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Chile" data-clocale="es-la" href="/es-la/">Chile</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Colombia" data-clocale="es-la" href="/es-la/">Colombia</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="México (Mexico)" data-clocale="es-la" href="/es-la/">México (Mexico)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Peru" data-clocale="es-la" href="/es-la/">Peru</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="United States" data-clocale="en-us" href="/">United States</a>
                                                </li>                                              		
                                              </div>
                                          </div>
                                      </div>
...
<script type="text/javascript">
   var uid= Math.random();   
   $('#countrylistgenerate').attr("id", uid);
   NVIDIAGDC.funcQueue.addToQueue({
           id: uid,
           method: "countrylistSelector",
           params: [{
                   id: uid                   
                    }]
      });
</script></div>
<div class="countrylistSelector parbase section">
        
        <div id="0.1776478148657159">
            <div class="countrylistselector       ">
                <div class="countrylistsection">
                    <div class="full-width  p-t-0 p-b-0 lap-p-t-0 lap-p-b-0 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0">
                        <div class="text-left lap-text-left tab-text-left mob-text-left">
                            ...
                            <div class="body-text description color-ui-elements">
                                <div class="countrieswrapper">
                                    <div>
                                        <div>
                                            <div class="countrylistsection">
                                            	<div class="text-left lap-text-left tab-text-left mob-text-left p-t-0 p-b-15 lap-p-t-0 lap-p-b-0 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0">
                                                	<h3 class="regiontitle">Europe</h3>
                                                </div>
                                                <div>
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="België (Belgium)" data-clocale="nl-nl" href="/nl-nl/">België (Belgium)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Belgique (Belgium)" data-clocale="fr-be" href="/fr-be/">Belgique (Belgium)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Česká Republika (Czech Republic)" data-clocale="cs-cz" href="/cs-cz/">Česká Republika (Czech Republic)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Danmark (Denmark)" data-clocale="da-dk" href="/da-dk/">Danmark (Denmark)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Deutschland (Germany)" data-clocale="de-de" href="/de-de/">Deutschland (Germany)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="España (Spain)" data-clocale="es-es" href="/es-es/">España (Spain)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="France" data-clocale="fr-fr" href="/fr-fr/">France</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Italia (Italy)" data-clocale="it-it" href="/it-it/">Italia (Italy)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Nederland (Netherlands)" data-clocale="nl-nl" href="/nl-nl/">Nederland (Netherlands)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Norge (Norway)" data-clocale="nb-no" href="/nb-no/">Norge (Norway)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Österreich (Austria)" data-clocale="de-at" href="/de-at/">Österreich (Austria)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Polska (Poland)" data-clocale="pl-pl" href="/pl-pl/">Polska (Poland)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="România (Romania)" data-clocale="ro-ro" href="/ro-ro/">România (Romania)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Suomi (Finland)" data-clocale="fi-fi" href="/fi-fi/">Suomi (Finland)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Sverige (Sweden)" data-clocale="sv-se" href="/sv-se/">Sverige (Sweden)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Türkiye (Turkey)" data-clocale="tr-tr" href="/tr-tr/">Türkiye (Turkey)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="United Kingdom" data-clocale="en-gb" href="/en-gb/">United Kingdom</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Rest of Europe" data-clocale="en-eu" href="/en-eu/">Rest of Europe</a>
                                                </li>                                              		
                                              </div>
                                          </div>
                                      </div>
                                    ...
                                    <div>
                                        <div>
                                            <div class="countrylistsection">
                                                ...
                                                <div>
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Australia" data-clocale="en-au" href="/en-au/">Australia</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="中国大陆 (Mainland China)" data-clocale="zh-cn" href="/zh-cn/">中国大陆 (Mainland China)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="India" data-clocale="en-in" href="/en-in/">India</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="日本 (Japan)" data-clocale="ja-jp" href="/ja-jp/">日本 (Japan)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="한국 (Korea)" data-clocale="ko-kr" href="/ko-kr/">한국 (Korea)</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Singapore" data-clocale="en-sg" href="/en-sg/">Singapore</a>
                                                </li>                                              		
                                              
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="台灣 (Taiwan)" data-clocale="zh-tw" href="/zh-tw/">台灣 (Taiwan)</a>
                                                </li>                                              		
                                              </div>
                                          </div>
                                      </div>
                                    ...
                                    <div>
                                        <div>
                                            <div class="countrylistsection">
                                                ...
                                                <div>
                                                	<li class="country text-left lap-text-left tab-text-left mob-text-left">
                                               		<a class="country_link" title="Middle East" data-clocale="en-me" href="/en-me/">Middle East</a>
                                                </li>                                              		
                                              </div>
                                          </div>
                                      </div>
