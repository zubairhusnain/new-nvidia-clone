...
@media screen and (min-width: 690px){
	.cleanslate .gallery-wrapper .prev {
	    margin: 0px 0px 0px -35px;
	}
	.cleanslate .gallery-wrapper .next {
	 	margin: 0px -35px 0px 0px;
	}
}
.heroBanner .slider-container .search-input-wrapper input{
	display: block;
}

#myprofile,#myprofile-mob{
	display: none;
}

.theme-nodpage .heroBanner .slider-container #slides1 .overflow {
	overflow-x: visible;
}

.heroBanner .cleanslate .nvidia-on-demand .search-form-container {
...
.navigation .global-nav .sub-brand-nav .brand-nav-left #sub-brand + .sub-brand-item{
    margin-left:0px;
}

.navigation .global-nav .nav-header-container .nav-tools-container .nav-header-list .nav-header-item #nod-login, .navigation .global-nav .nav-header-container .nav-tools-container .nav-header-list .nav-header-item #nod-logout {
     background-color: #76b900;
     color: #fff;
}

#nvidia-gallery-widget1 .featured-info .speakers {
     visibility: hidden;
}
...
;(function ( nvidiaGDC ){
    ...
    nvidiaGDC.addProperty('nod', 'gattedMsg', 'To enjoy this content please login or join the free NVIDIA Developer Program');
    nvidiaGDC.addProperty('nod', 'gattedfileMsg', 'To enjoy this content please login or join the free NVIDIA Developer Program');
    nvidiaGDC.addProperty('nod', 'usergattedMsg', 'To enjoy this content join the free NVIDIA Developer Program');
    nvidiaGDC.addProperty('nod', 'usergattedfileMsg', 'To enjoy this content join the free NVIDIA Developer Program');
    nvidiaGDC.addProperty('nod', 'starfleetRedirect', 'https://www.nvidia.com/auth/?client_id=VjclBI-aX9TkJYWklBkyDI-gXTFrjY6yHz8I-OdQlP4');
    nvidiaGDC.addProperty('nod', 'SearchLandigPage', 'https://www.nvidia.com/en-us/on-demand/search/');
    nvidiaGDC.addProperty('nod', 'SessionDetailsPage', 'https://www.nvidia.com/en-us/on-demand/session/'); 
    nvidiaGDC.addProperty('nod', 'srvcendpoint', 'https://api-prod.nvidia.com');
    nvidiaGDC.addProperty('nod', 'PlaylistDetailsPage', 'https://www.nvidia.com/en-us/on-demand/playlist/');
    nvidiaGDC.addProperty('nod', 'MyProfilePage', 'https://www.nvidia.com/en-us/on-demand/my-profile/');
    nvidiaGDC.addProperty('nod', 'search', 'https://api-prod.nvidia.com/search/nvidia-search-library.js');
    nvidiaGDC.addProperty('nod', 'searchsrvc', 'https://api-prod.nvidia.com/search/graphql');
    nvidiaGDC.addProperty('nod', 'roles', 'developer');
    ...
    nvidiaGDC.addProperty('nod', 'promoimg', '');
    nvidiaGDC.addProperty('nod', 'promourl', '');
...
;(function ( nvidiaGDC ){
    ...
    nvidiaGDC.SC.vars.pageTemplate = "/apps/nvidiaGDC/templates/nodPage".toLowerCase();
...
<body class="body-page theme-en-us theme-nodpage  v4_design base_v4" data-edit-mode="">
...
<!-- Hero Banner -->
<div class="slider-container five-items m-t-0 m-b-0 lap-m-t-0 lap-m-b-0 tab-m-t-0 tab-m-b-0  mob-m-t-0 mob-m-b-0 background-none " id="herobanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d">
	...
	<div id="slides1" class="singleSlideBanner">
		<div class="overflow">
			<div class="inner">
						...
						<article data-bcgcustomcolor=" data-bcgimagetablet="../assets/www.nvidia.com/content/dam/graphics/key-visual/2026/dark/nvidia-kv-2026-bm-lg440-t@2x.jpg" data-bcgimagelaptop="../assets/www.nvidia.com/content/dam/graphics/key-visual/2026/dark/nvidia-kv-2026-bm-lg580-l@2x.jpg" data-bcgimagemobile="../assets/www.nvidia.com/content/dam/graphics/key-visual/2026/dark/nvidia-kv-2026-wmfg1080-p@2x.jpg" data-bcgimagepc="../assets/www.nvidia.com/content/dam/graphics/key-visual/2026/dark/nvidia-kv-2026-bm-lg580-d@2x.jpg" data-time="7" class="background-darkgray-1 ht-580  image lazyloading" id="herobanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d_sld1">
    ...
    <div id="textcomponentenhance925b6513_8741_405d_8532_459504fc35cf">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-0 p-b-0  lap-p-t-0 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-left lap-text-left tab-text-left mob-text-left">
	            ...
	            <h1 class="title color-white   h1 uppercase">NVIDIA On-Demand</h1>
            	...
            	<div class="description color-white no-space intro-copy-text"><p>Watch the latest videos on AI breakthroughs and real-world applications—free and on your schedule.</p> 
<p>
 <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
  <path d="M5.625 5V7.5H11.875V5C11.875 3.28125 10.4688 1.875 8.75 1.875C6.99219 1.875 5.625 3.28125 5.625 5ZM3.75 7.5V5C3.75 2.26562 5.97656 0 8.75 0C11.4844 0 13.75 2.26562 13.75 5V7.5H15.625H17.5V9.375V18.125V20H15.625H1.875H0V18.125V9.375V7.5H1.875H3.75ZM1.875 18.125H15.625V9.375H1.875V18.125Z" fill="white"></path> 
 </svg><span class="p--small" style="padding-left: 5.0px;">Some content may require membership in our free <a href="https://developer.nvidia.com/developer-program" target="_blank" rel="noopener noreferrer">NVIDIA Developer Program</a>.</span></p></div>
...
<div id="nvidia-search-input-widget"><div class="nvidia-search-widget"><div class="cleanslate"><div class="nvidia-on-demand"><div class="search-form-container"><div class="search-input-wrapper"><div class="search-input-block"><div class="search-input-left"><button type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="search-icon" width="48" height="48"><path d="M0 0h48v48H0Z" style="fill: none;"></path><path d="M28 25h-1.58l-.56-.54a13.02 13.02 0 1 0-1.4 1.4l.54.56V28l10 9.98L37.98 35Zm-12 0a9 9 0 1 1 9-9 8.988 8.988 0 0 1-9 9Z" transform="translate(3 3)" style="fill: currentcolor;"></path></svg></button></div><div class="search-input-right"><input type="search" placeholder="Search.." role="combobox" autocomplete="off" aria-expanded="false" aria-haspopup="listbox" aria-autocomplete="list" value=""></div></div></div></div></div></div></div></div> 
<script>
        NvidiaSearchLibrary.SearchInputWidget.mount({
        site: 'https://www.nvidia.com',
       language: $('html').attr('lang'),
        queryParam: 'q',
        apiUrl: NVIDIAGDC.apps.searchsrvc,
         destination: NVIDIAGDC.nod.SearchLandigPage,
...
<div class="button parbase section">
		...
		<div class="text-left lap-text-left tab-text-left mob-text-left p-t-15 p-b-15 lap-p-t-15 lap-p-b-15 tab-p-t-0 tab-p-b-0 mob-p-t-0 mob-p-b-0 mobile-align ">
			<div class="noicon  ">
				<a href="/on-demand/search/" data-analytics="txt-manual:" data-title=" data-href="/on-demand/search/" target="_self" class="  link-txt txt-manual brand-green regular-btn " onclick="NVIDIAGDC.button.click(this, $(this).data(&quot;href&quot;),true, function() { ;return NVIDIAGDC.button.callbacks(this); }); return false;"><div class="btn"><span><svg xmlns="http://www.w3.org/2000/svg" width="154" height="20" viewBox="0 0 154 20" fill="none"> <path d="M0.59825 16L4.91825 4.8H7.01425L11.3503 16H8.82225L8.02225 13.744H3.78225L2.98225 16H0.59825ZM4.47025 11.824H7.33425L5.91025 7.808L4.47025 11.824ZM15.5949 16.224C14.9335 16.224 14.3415 16.0693 13.8189 15.76C13.2962 15.44 12.8855 14.9707 12.5869 14.352C12.2989 13.7333 12.1549 12.9813 12.1549 12.096V11.616C12.1549 10.7307 12.2989 9.984 12.5869 9.376C12.8855 8.768 13.2962 8.30933 13.8189 8C14.3415 7.68 14.9335 7.52 15.5949 7.52H15.7069C16.6989 7.52 17.4722 7.85067 18.0269 8.512V4.32H20.2669V16H18.3149V14.976C17.7495 15.808 16.8802 16.224 15.7069 16.224H15.5949ZM16.1869 14.304H16.3149C16.6029 14.304 16.8802 14.2347 17.1469 14.096C17.4135 13.9467 17.6322 13.712 17.8029 13.392C17.9735 13.072 18.0589 12.6507 18.0589 12.128V11.616C18.0589 11.0933 17.9682 10.672 17.7869 10.352C17.6162 10.032 17.3975 9.80267 17.1309 9.664C16.8642 9.51467 16.5922 9.44 16.3149 9.44H16.1869C15.6749 9.44 15.2482 9.61067 14.9069 9.952C14.5655 10.2933 14.3949 10.8427 14.3949 11.6V12.128C14.3949 12.8853 14.5655 13.44 14.9069 13.792C15.2482 14.1333 15.6749 14.304 16.1869 14.304ZM24.5925 16L21.4885 7.744H23.8565L25.6325 13.264L27.4565 7.744H29.6805L26.5765 16H24.5925ZM32.799 16.224C31.9137 16.224 31.2257 16.0053 30.735 15.568C30.255 15.1307 30.015 14.5173 30.015 13.728C30.015 13.0027 30.2337 12.4213 30.671 11.984C31.119 11.5467 31.7643 11.2747 32.607 11.168L35.199 10.832V10.768C35.199 9.79733 34.7563 9.312 33.871 9.312H33.711C33.3163 9.312 32.9857 9.38667 32.719 9.536C32.4523 9.67467 32.2283 9.92533 32.047 10.288L30.335 9.392C30.5803 8.82667 30.991 8.37333 31.567 8.032C32.1537 7.69067 32.863 7.52 33.695 7.52H33.935C36.271 7.52 37.439 8.61333 37.439 10.8V16H35.487V14.96C35.231 15.3547 34.8737 15.664 34.415 15.888C33.967 16.112 33.455 16.224 32.879 16.224H32.799ZM35.199 12.336L33.487 12.576C32.9963 12.6507 32.655 12.7573 32.463 12.896C32.271 13.024 32.175 13.2373 32.175 13.536C32.175 13.824 32.2817 14.0533 32.495 14.224C32.719 14.384 33.0123 14.464 33.375 14.464H33.503C34.0363 14.464 34.4523 14
obanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d",
			method : "herobanner",
			params : [{
				lastSlide:"slide1-herobanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d",
				slidecount:1,
				period:7,
				autoslidedisable:false,
				pageoldbreakpointvalue: 'false',
				id:"herobanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d",
				articleID:"herobanner_copyd3196dc2_56cc_44a1_86ee_edb7373e222d",
				lazyloded: true
				}]
		});
	</script>
...
<section class=" background-white p-t-75 p-b-75 lap-p-t-75 lap-p-b-75 tab-p-t-45 tab-p-b-45 mob-p-t-45 mob-p-b-45      " style="background-image: url(&quot;&quot;);">
	<div id="sectionenhanced098395e0_a03d_4082_a0d8_ebda983cfcf4" class="general-container ">
...
<div id="nvidia-gallery-widget0" class="widget" data-affinity="Other"></div>
...
<div class=" p-t-75 p-b-15 lap-p-t-75 lap-p-b-15 mob-p-t-45 mob-p-b-15 tab-p-t-45 tab-p-b-15">
...
<div id="nvidia-gallery-widget1" class="widget" data-affinity="Other"></div>
...
<script type="text/javascript">
	...
	NVIDIAGDC.funcQueue.addToQueue({
		id : "sectionenhanced098395e0_a03d_4082_a0d8_ebda983cfcf4",
...
<section id="events-section" class=" background-white p-t-45 p-b-0 lap-p-t-45 lap-p-b-0 tab-p-t-30 tab-p-b-0 mob-p-t-30 mob-p-b-0      " style="background-image: url(&quot;&quot;);">
	<div id="sectionenhanced_2073590224e062ee1a_fd82_4c5c_bbc0_27ec5eac1510" class="general-container ">
	<div class="large-12 large-12 medium-12 small-12 center">
    ...
    <div id="textcomponentenhance8f6da1f7_cf79_4906_a94a_92d2ebaf44ce">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-0 p-b-0  lap-p-t-0 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-center lap-text-center tab-text-center mob-text-center">
	            ...
	            <h2 class="title color-black   h2 uppercase">Recent Events</h2>
	            
            
            
            
            <div class="text-button">
				<div class="textCmpEnhancedButton-par parsys"><div class="textcomponentenhanced section">

                      

    <div id="textcomponentenhance_7732684022f8b7bbd_6781_489c_9a4f_4b7c3acce045">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-30 p-b-0  lap-p-t-30 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-center lap-text-center tab-text-center mob-text-center">
	            ...
	            <h3 class="title color-black  h3 uppercase">GTC 2026</h3>
...
<div class=" p-t-45 p-b-15 lap-p-t-45 lap-p-b-15 mob-p-t-45 mob-p-b-15 tab-p-t-45 tab-p-b-15">
...
<div id="nvidia-gallery-widget2" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_627024727fdb69720_74d2_4697_a757_9f77830de64f">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-15 p-b-0  lap-p-t-15 lap-p-b-0  tab-p-t-15 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
...
<div id="nvidia-gallery-widget3" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_7372378af388802_856d_40d1_84ff_71fd6426afed">
...
<div id="nvidia-gallery-widget4" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance2ac5ff7f_e844_442a_99f6_267a24ce336b">
...
<div id="nvidia-gallery-widget5" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_184317019d9729aa6_77d4_4e3a_b931_857b8edceb0a">
...
<div id="nvidia-gallery-widget6" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_7393178724520379a_50a6_4ccf_9389_85f4e14b9b3d">
...
<div id="nvidia-gallery-widget7" class="widget" data-affinity="Other"></div>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_1824761311c1d3a9fd_12bc_47f1_ada1_e68937fce388">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-60 p-b-0  lap-p-t-60 lap-p-b-0  tab-p-t-45 tab-p-b-0  mob-p-t-30 mob-p-b-0 ">
        ...
        <div class="text-center lap-text-center tab-text-center mob-text-center">
	            ...
	            <h3 class="title color-black  h3 uppercase">GTC Washington, D.C 2025</h3>
...
<div id="nvidia-gallery-widget8" class="widget" data-affinity="Other"></div>
...
<script type="text/javascript">
	...
	NVIDIAGDC.funcQueue.addToQueue({
		id : "sectionenhanced_2073590224e062ee1a_fd82_4c5c_bbc0_27ec5eac1510",
		method : "sectionEnhancedComponent",
		params : [{
				imageDesktopUrl:' ',
				imageLaptopUrl:' ',
...
<section id="training-section" class=" background-white p-t-75 p-b-75 lap-p-t-75 lap-p-b-75 tab-p-t-45 tab-p-b-45 mob-p-t-45 mob-p-b-45      " style="background-image: url(&quot;&quot;);">
	<div id="sectionenhanced_1450911466ac27db6_d4fc_4634_8b3c_af271b1932dd" class="general-container ">
	<div class="large-12 large-12 medium-12 small-12 center">
    ...
    <div id="textcomponentenhance07baeb04_a91a_4f9e_83bb_5fc46a3dfaf2">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-0 p-b-0  lap-p-t-0 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-center lap-text-center tab-text-center mob-text-center">
	            ...
	            <h2 class="title color-black   h2 uppercase">NVIDIA Tools and Training Resources</h2>
...
<div class="textcomponentenhanced section">
    ...
    <div id="textcomponentenhance_9426264305d2d1c8d_5eda_4f29_9a37_ab11e4d3a311">
	...
	<div class="general-container-text small-12 mob-p-content medium-12 tab-p-content large-12 lap-p-content large-12 d-p-content  p-t-30 p-b-0  lap-p-t-30 lap-p-b-0  tab-p-t-0 tab-p-b-0  mob-p-t-0 mob-p-b-0 ">
        ...
        <div class="text-center lap-text-center tab-text-center mob-text-center">
	            ...
	            <h3 class="title color-black  h3 uppercase">NVIDIA Training Labs</h3>
...
<div id="nvidia-gallery-widget9" class="widget"></div>
...
<script type="text/javascript">
	...
	NVIDIAGDC.funcQueue.addToQueue({
		id : "sectionenhanced_1450911466ac27db6_d4fc_4634_8b3c_af271b1932dd",
		method : "sectionEnhancedComponent",
		params : [{
				imageDesktopUrl:' ',
				imageLaptopUrl:' ',
    ...
    function updateWidget() {
        ...
        var apiUrl = NVIDIAGDC.nod.searchsrvc;
         ...
         if (typeof NVIDIAGDC.NOD!== "undefined" && NVIDIAGDC.NOD.getSession() ) {
			...
			if(NVIDIAGDC.NOD.getSession().message==='VALID_SESSION'){
            //logged in   
            jwtToken = NVIDIAGDC.NOD.getSession().id_token;
            if (typeof Cookies !== "undefined" && typeof Cookies.get("nv.profile") !== "undefined") {
                searchJWTToken = JSON.parse(decodeURI($.base64.decode(Cookies.get("nv.profile"))))["jwtToken"];
                roles = JSON.parse(decodeURI($.base64.decode(Cookies.get("nv.profile"))))["nv.program"];
            } else if (typeof Cookies !== "undefined" && typeof Cookies.get("nv.profile") === "undefined") {
        ...
        NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget0',
            searchInput: searchInput0,
            site: 'https://www.nvidia.com',
            language: $('html').attr('lang'),
            voltronApiUrl: voltronApiUrl,
            apiUrl: NVIDIAGDC.nod.searchsrvc,
            playlistId: 'playList-5d17c33f-65f5-4fb1-9fed-bc5b7f4dec44',
            isFeatured: true,
            header: 'NVIDIA Keynotes and Related Talks',
            destinationSite: destinationSite,
            destination: destinationSite + '/en-us/on-demand/playlist/playList-5d17c33f-65f5-4fb1-9fed-bc5b7f4dec44/',
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-featured-0',
        ...
        NvidiaSearchLibrary.GalleryWidget.mount({
            ...
            playlistId: 'playList-d77614ca-829e-45f3-9620-60c692143a93',
            destination: destinationSite + '/en-us/on-demand/playlist/playList-d77614ca-829e-45f3-9620-60c692143a93/',
            destinationSite: destinationSite,
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-2'
        });
		
	 NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget3',
            header: 'Live at GTC 2026',
            ...
            apiUrl: apiUrl,
            isFeaturedPlaylist: false,
            playlistId: 'playList-66732a17-78c9-4bd0-8140-0a39aac9a8df',
            destination: destinationSite + '/en-us/on-demand/playlist/playList-66732a17-78c9-4bd0-8140-0a39aac9a8df/',
            destinationSite: destinationSite,
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-3'
        });	

 NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget4',
            header: 'Latest in Agentic AI and Reasoning AI',
            searchInput: searchInput4,
            site: site,
            language: language,
            voltronApiUrl: voltronApiUrl,
            apiUrl: apiUrl,
            isFeaturedPlaylist: false,
            playlistId: 'playList-c87e1663-1228-4443-a037-c776dc855d9b',
            destination: destinationSite + '/en-us/on-demand/playlist/playList-c87e1663-1228-4443-a037-c776dc855d9b/',
            destinationSite: destinationSite,
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-4'
        });

 NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget5',
            header: 'Latest in Physical AI and Robotics',
            searchInput: searchInput5,
            site: site,
            language: language,
            voltronApiUrl: voltronApiUrl,
            apiUrl: apiUrl,
            isFeaturedPlaylist: false,
            playlistId: 'playList-1520a961-42dc-4f65-97c2-c83e35cf4a33',
            destination: destinationSite + '/en-us/on-demand/playlist/playList-1520a961-42dc-4f65-97c2-c83e35cf4a33/',
            destinationSite: destinationSite,
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-5'
        });	
	...
	NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget6',
            header: 'Latest in AI Factories and Scaling AI',
            searchInput: searchInput6,
            site: 'https://www.nvidia.com',
            language: $('html').attr('lang'),
            voltronApiUrl: voltronApiUrl,
            apiUrl: apiUrl, 
            isFeaturedPlaylist: false,
            playlistId: 'playList-64861bf7-5e11-436a-91e2-d8ec1c0503da',
            destination: 'https://www.nvidia.com/en-us/on-demand/playlist/playList-64861bf7-5e11-436a-91e2-d8ec1c0503da/',
            ...
            searchToken: searchJWTToken,
            accessRoles: roles,
	    linkUrlPrefix:'https://www.nvidia.com/en-us/on-demand/session/',
            openSessionInNewTab: true,
            widgetPlacementId: 'nvod-home-widget-playlist-6'
        });	
		
		
       NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget7',
            searchInput: searchInput7,
            site: 'https://www.nvidia.com',
            language: $('html').attr('lang'),
            voltronApiUrl: voltronApiUrl,
            apiUrl: NVIDIAGDC.nod.searchsrvc,
            playlistId: 'playList-e04d8e91-506f-47f2-95d2-f88895a9a1b3',
            isFeatured: false,
            header: 'Latest in Claws and Long-Running Agents',
            destinationSite: destinationSite,
            destination: destinationSite + '/en-us/on-demand/playlist/playList-e04d8e91-506f-47f2-95d2-f88895a9a1b3/',
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-7',
        });   

     NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget8',
            searchInput: searchInput8,
            site: 'https://www.nvidia.com',
            language: $('html').attr('lang'),
            voltronApiUrl: voltronApiUrl,
            apiUrl: NVIDIAGDC.nod.searchsrvc,
            playlistId: 'playList-45965c6b-80b8-47a1-a460-babada13b57e',
            isFeatured: false,
            header: 'GTC Washington, D.C 2025 Top Talks',
            destinationSite: destinationSite,
            destination: destinationSite + '/en-us/on-demand/playlist/playList-45965c6b-80b8-47a1-a460-babada13b57e/',
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-8',
        });   

    NvidiaSearchLibrary.GalleryWidget.mount({
            elementId: 'nvidia-gallery-widget9',
            searchInput: searchInput9,
            site: 'https://www.nvidia.com',
            language: $('html').attr('lang'),
            voltronApiUrl: voltronApiUrl,
            apiUrl: NVIDIAGDC.nod.searchsrvc,
            playlistId: 'playList-108242b0-35ac-4765-9796-d6961cb026c4',
            isFeatured: false,
            header: 'Featured Training Labs',
            destinationSite: destinationSite,
            destination: destinationSite + '/en-us/on-demand/playlist/playList-108242b0-35ac-4765-9796-d6961cb026c4/',
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => { },
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-9',
        });  
...
$.ajax({
     url: "https://api-prod.nvidia.com/nvidia-asset-recommender/",
     type: "POST",
     data: data,
    contentType: "application/json",
     success: function(data) {
   // var Stringrecc =data.outputs[8].data;
   const recc =data.outputs[12].data;
   const Stringrecc = recc .join(',');
    console.log('data', data);
       NvidiaSearchLibrary.GalleryWidget.mount({
            ...
            isFeaturedPlaylist: false,
            playlistId: Stringrecc ,
            destination: destinationSite + '/en-us/on-demand/featured-playlist/' ,
            destinationSite: destinationSite,
            ...
            searchToken: searchJWTToken,
            accessRoles: roles,
            widgetPlacementId: 'nvod-home-widget-playlist-1'
        });
 ...
 setTimeout(function() { updateWidget(); }, 2000);
...
<style>
/* CSS for see all prev/next CTA */
@media screen and (min-width: 690px){
	div[id^="nvidia-gallery-widget"] .cleanslate .gallery-wrapper .prev {
	    margin: 0px 0px 0px 0px;
	}
	div[id^="nvidia-gallery-widget"] .cleanslate .gallery-wrapper .next {
	 	margin: 0px 0px 0px 0px;
	}
}
</style>
...
window.addEventListener('load', () => {
    LIBRARIAN.Home.mount({
        ...
        <script src="../assets/www.nvidia.com/etc/designs/nvidiaGDC/clientlibs_base.min.1636c5282c77b207f6ec21834a3d3f73.js"></script>
...
<script>
$(document).ready(function() {
	NVIDIAGDC.Browser.getUrlParameter('ncid')
	var ncidval = NVIDIAGDC.Browser.getUrlParameter("ncid");
		if (ncidval && ncidval.length > 1) {
			const cookieName = "SESSncid";
			const cookieValue = ncidval;
			document.cookie = cookieName + '=' + cookieValue + ';path=/' + '; domain=.nvidia.com'; 
		}
