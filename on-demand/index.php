...
;(function ( nvidiaGDC ){
    ...
    nvidiaGDC.addProperty('nod', 'starfleetRedirect', '/auth/?client_id=VjclBI-aX9TkJYWklBkyDI-gXTFrjY6yHz8I-OdQlP4');
    nvidiaGDC.addProperty('nod', 'SearchLandigPage', '/on-demand/search/');
    nvidiaGDC.addProperty('nod', 'SessionDetailsPage', '/on-demand/session/'); 
    nvidiaGDC.addProperty('nod', 'srvcendpoint', './assets/api-prod.nvidia.com/');
    nvidiaGDC.addProperty('nod', 'PlaylistDetailsPage', '/on-demand/playlist/');
    nvidiaGDC.addProperty('nod', 'MyProfilePage', '/on-demand/my-profile/');
    nvidiaGDC.addProperty('nod', 'search', './assets/api-prod.nvidia.com/search/nvidia-search-library.js');
    nvidiaGDC.addProperty('nod', 'searchsrvc', './assets/api-prod.nvidia.com/search/graphql');
...
<p>
 ...
 </svg><span class="p--small" style="padding-left: 5.0px;">Some content may require membership in our free <a href="./assets/developer.nvidia.com/developer-program" target="_blank" rel="noopener noreferrer">NVIDIA Developer Program</a>.</span></p></div>
...
<script>
 ...
 NvidiaSearchLibrary.GalleryWidget.mount({
	...
	NvidiaSearchLibrary.GalleryWidget.mount({
            ...
            destination: '/on-demand/playlist/playList-64861bf7-5e11-436a-91e2-d8ec1c0503da/',
            destinationSite: '/',
            jwtToken: jwtToken,
            onLogin: () => { NVIDIAGDC.NOD.login() },
            onLogout: () => {  },
            searchToken: searchJWTToken,
            accessRoles: roles,
	    linkUrlPrefix:'/on-demand/session/',
...
$.ajax({
     url: "./assets/api-prod.nvidia.com/nvidia-asset-recommender/",
     type: "POST",
     data: data,
